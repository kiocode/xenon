...
// Function Instruction_base.Instruction_base_C.OnInstructionComplete__DelegateSignature
// 0x0004 (0x0004 - 0x0000)
struct Instruction_base_C_OnInstructionComplete__DelegateSignature final
{
public:
	int32                                         Instruction;                                       // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(Instruction_base_C_OnInstructionComplete__DelegateSignature) == 0x000004, "Wrong alignment on Instruction_base_C_OnInstructionComplete__DelegateSignature");
static_assert(sizeof(Instruction_base_C_OnInstructionComplete__DelegateSignature) == 0x000004, "Wrong size on Instruction_base_C_OnInstructionComplete__DelegateSignature");
static_assert(offsetof(Instruction_base_C_OnInstructionComplete__DelegateSignature, Instruction) == 0x000000, "Member 'Instruction_base_C_OnInstructionComplete__DelegateSignature::Instruction' has a wrong offset!");
