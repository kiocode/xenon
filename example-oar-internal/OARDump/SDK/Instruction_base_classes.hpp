...
public:
	...
	FMulticastInlineDelegateProperty_             OnInstructionComplete;                             // 0x0270(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)

public:
	void OnInstructionComplete__DelegateSignature(int32 Instruction);
