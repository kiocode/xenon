...
public:
	...
	class UCoinSkinPreview_C*                     CallFunc_Create_ReturnValue;                       // 0x0060(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_BLoggedOn_ReturnValue;                    // 0x0089(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FSteamItemDef                          K2Node_MakeStruct_SteamItemDef;                    // 0x00C8(0x0004)(NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_CC[0x4];                                       // 0x00CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<int32>                                 K2Node_MakeArray_Array;                            // 0x00D0(0x0010)(ConstParm, ReferenceParm)
	TArray<struct FSteamItemDef>                  K2Node_MakeArray_Array_1;                          // 0x00E0(0x0010)(ConstParm, ReferenceParm)
	class USteamCoreInventoryAsyncActionStartPurchaseResult* CallFunc_StartPurchaseAsync_ReturnValue;           // 0x00F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(struct FSteamInventoryStartPurchaseResult& Data, bool bWasSuccessful)> K2Node_CreateDelegate_OutputDelegate;              // 0x00F8(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue_1;                    // 0x0108(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BLoggedOn_ReturnValue_1;                  // 0x0109(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsLocalController_ReturnValue;            // 0x010A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_10B[0x1];                                      // 0x010B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSteamItemDef                          K2Node_MakeStruct_SteamItemDef_1;                  // 0x010C(0x0004)(NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetItemPrice_Price;                       // 0x0110(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetItemPrice_BasePrice;                   // 0x0114(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetItemPrice_ReturnValue;                 // 0x0118(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          Temp_bool_IsClosed_Variable;                       // 0x0119(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_11A[0x2];                                      // 0x011A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_Get_Current_Rotation_Number_Rotation_number; // 0x011C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTimespan                              CallFunc_Get_Current_Rotation_Number_Time_left;    // 0x0120(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	EShopItemCategory                             CallFunc_Array_Get_Item;                           // 0x0128(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UClass*                                 CallFunc_GetCoinBundleSkin_Skin;                   // 0x0130(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild) == 0x000148, "Wrong size on CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild");
...
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_Create_ReturnValue) == 0x000060, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, Temp_bool_Has_Been_Initd_Variable) == 0x000068, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, Temp_int_Loop_Counter_Variable) == 0x00006C, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_Add_IntInt_ReturnValue) == 0x000070, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, Temp_int_Array_Index_Variable) == 0x000074, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_GetPlayerController_ReturnValue) == 0x000078, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_GetPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, K2Node_DynamicCast_AsRobber_Controller) == 0x000080, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::K2Node_DynamicCast_AsRobber_Controller' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, K2Node_DynamicCast_bSuccess) == 0x000088, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_BLoggedOn_ReturnValue) == 0x000089, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_BLoggedOn_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, K2Node_Event_IsDesignTime) == 0x00008A, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_IsValid_ReturnValue) == 0x00008B, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_Conv_IntToText_ReturnValue) == 0x000090, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_GetAnimationCurrentTime_ReturnValue) == 0x0000A8, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_GetAnimationCurrentTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_PlayAnimation_ReturnValue) == 0x0000B0, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_PlayAnimation_ReturnValue_1) == 0x0000B8, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_PlayAnimation_ReturnValue_2) == 0x0000C0, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_PlayAnimation_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, K2Node_MakeStruct_SteamItemDef) == 0x0000C8, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::K2Node_MakeStruct_SteamItemDef' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, K2Node_MakeArray_Array) == 0x0000D0, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, K2Node_MakeArray_Array_1) == 0x0000E0, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_StartPurchaseAsync_ReturnValue) == 0x0000F0, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_StartPurchaseAsync_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, K2Node_CreateDelegate_OutputDelegate) == 0x0000F8, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_IsValid_ReturnValue_1) == 0x000108, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_BLoggedOn_ReturnValue_1) == 0x000109, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_BLoggedOn_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_IsLocalController_ReturnValue) == 0x00010A, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_IsLocalController_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, K2Node_MakeStruct_SteamItemDef_1) == 0x00010C, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::K2Node_MakeStruct_SteamItemDef_1' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_GetItemPrice_Price) == 0x000110, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_GetItemPrice_Price' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_GetItemPrice_BasePrice) == 0x000114, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_GetItemPrice_BasePrice' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_GetItemPrice_ReturnValue) == 0x000118, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_GetItemPrice_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, Temp_bool_IsClosed_Variable) == 0x000119, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::Temp_bool_IsClosed_Variable' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_Get_Current_Rotation_Number_Rotation_number) == 0x00011C, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_Get_Current_Rotation_Number_Rotation_number' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_Get_Current_Rotation_Number_Time_left) == 0x000120, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_Get_Current_Rotation_Number_Time_left' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_Array_Get_Item) == 0x000128, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_Array_Length_ReturnValue) == 0x00012C, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_GetCoinBundleSkin_Skin) == 0x000130, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_GetCoinBundleSkin_Skin' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_Less_IntInt_ReturnValue) == 0x000138, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild, CallFunc_AddChild_ReturnValue) == 0x000140, "Member 'CoinShopUIChild_C_ExecuteUbergraph_CoinShopUIChild::CallFunc_AddChild_ReturnValue' has a wrong offset!");
