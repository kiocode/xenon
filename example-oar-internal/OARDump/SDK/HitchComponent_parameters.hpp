...
// Function HitchComponent.HitchComponent_C.EnableHitch__DelegateSignature
// 0x0008 (0x0008 - 0x0000)
struct HitchComponent_C_EnableHitch__DelegateSignature final
{
public:
...
static_assert(alignof(HitchComponent_C_EnableHitch__DelegateSignature) == 0x000008, "Wrong alignment on HitchComponent_C_EnableHitch__DelegateSignature");
static_assert(sizeof(HitchComponent_C_EnableHitch__DelegateSignature) == 0x000008, "Wrong size on HitchComponent_C_EnableHitch__DelegateSignature");
static_assert(offsetof(HitchComponent_C_EnableHitch__DelegateSignature, Hitch) == 0x000000, "Member 'HitchComponent_C_EnableHitch__DelegateSignature::Hitch' has a wrong offset!");
