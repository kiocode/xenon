...
// Parameters:
// int32                                   Instruction                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AInstruction_base_C::OnInstructionComplete__DelegateSignature(int32 Instruction)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Instruction_base_C", "OnInstructionComplete__DelegateSignature");

	Params::Instruction_base_C_OnInstructionComplete__DelegateSignature Parms{};
