#include <xenon/core/gui_external.hpp>
...
LRESULT __stdcall window_procedure(HWND window, UINT message, WPARAM w_param, LPARAM l_param) {
...
void ui::CreateHUIWindow() noexcept
{
