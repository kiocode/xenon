...
void CEsp::RenderSnapline() const {
	...
	for (auto& target : g_pXenonConfigs->g_pGameVariables->g_vTargets) {
...
void CEsp::RenderSkeleton() const {
...
void CEsp::RenderHealthBar() const {
