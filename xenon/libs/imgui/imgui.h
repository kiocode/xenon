...
namespace ImGui
{
    ...
    IMGUI_API bool          Achievement(const char* label, const ImVec2& size_arg, bool islocked = false, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Tabs(const char* label, const ImVec2& size_arg, bool selected, ImColor animCRegular, ImColor animCSelected, ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, ImColor bgC, ImColor offC, ImColor onC);
