...
static_assert(offsetof(UPyWidget_MissionRefreshPanel, HoverListGuide) == 0x000618, "Member 'UPyWidget_MissionRefreshPanel::HoverListGuide' has a wrong offset!");
static_assert(offsetof(UPyWidget_MissionRefreshPanel, RefreshGuide) == 0x000728, "Member 'UPyWidget_MissionRefreshPanel::RefreshGuide' has a wrong offset!");
