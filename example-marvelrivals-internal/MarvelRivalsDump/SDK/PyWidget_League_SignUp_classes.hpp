...
public:
	...
	int32                                         FlagSizeX;                                         // 0x0614(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         FlagSizeY;                                         // 0x0618(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_League_SignUp) == 0x000620, "Wrong size on UPyWidget_League_SignUp");
static_assert(offsetof(UPyWidget_League_SignUp, FlagSizeX) == 0x000614, "Member 'UPyWidget_League_SignUp::FlagSizeX' has a wrong offset!");
static_assert(offsetof(UPyWidget_League_SignUp, FlagSizeY) == 0x000618, "Member 'UPyWidget_League_SignUp::FlagSizeY' has a wrong offset!");
...
{
public:
	bool                                          IsTitlePlatformVisible;                            // 0x1570(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UWBP_DropDownList_League_SignUp) == 0x001580, "Wrong size on UWBP_DropDownList_League_SignUp");
static_assert(offsetof(UWBP_DropDownList_League_SignUp, IsTitlePlatformVisible) == 0x001570, "Member 'UWBP_DropDownList_League_SignUp::IsTitlePlatformVisible' has a wrong offset!");
...
static_assert(sizeof(UPywidget_DropDownList_SignUp_Item) == 0x000790, "Wrong size on UPywidget_DropDownList_SignUp_Item");
...
static_assert(sizeof(UPyWidget_DropDownList_SignUp_ListView) == 0x000628, "Wrong size on UPyWidget_DropDownList_SignUp_ListView");
