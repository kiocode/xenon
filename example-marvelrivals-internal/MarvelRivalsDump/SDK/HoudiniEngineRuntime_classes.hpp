...
static_assert(sizeof(AHoudiniAssetActor) == 0x000498, "Wrong size on AHoudiniAssetActor");
static_assert(offsetof(AHoudiniAssetActor, HoudiniAssetComponent) == 0x000490, "Member 'AHoudiniAssetActor::HoudiniAssetComponent' has a wrong offset!");
...
static_assert(sizeof(UHoudiniAssetComponent) == 0x000DC0, "Wrong size on UHoudiniAssetComponent");
static_assert(offsetof(UHoudiniAssetComponent, HoudiniAsset) == 0x000840, "Member 'UHoudiniAssetComponent::HoudiniAsset' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCookOnParameterChange) == 0x000848, "Member 'UHoudiniAssetComponent::bCookOnParameterChange' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bUploadTransformsToHoudiniEngine) == 0x000849, "Member 'UHoudiniAssetComponent::bUploadTransformsToHoudiniEngine' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCookOnTransformChange) == 0x00084A, "Member 'UHoudiniAssetComponent::bCookOnTransformChange' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCookOnAssetInputCook) == 0x00084B, "Member 'UHoudiniAssetComponent::bCookOnAssetInputCook' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bOutputless) == 0x00084C, "Member 'UHoudiniAssetComponent::bOutputless' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bOutputTemplateGeos) == 0x00084D, "Member 'UHoudiniAssetComponent::bOutputTemplateGeos' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bUseOutputNodes) == 0x00084E, "Member 'UHoudiniAssetComponent::bUseOutputNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, TemporaryCookFolder) == 0x000850, "Member 'UHoudiniAssetComponent::TemporaryCookFolder' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, BakeFolder) == 0x000860, "Member 'UHoudiniAssetComponent::BakeFolder' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, StaticMeshMethod) == 0x000870, "Member 'UHoudiniAssetComponent::StaticMeshMethod' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, StaticMeshGenerationProperties) == 0x000878, "Member 'UHoudiniAssetComponent::StaticMeshGenerationProperties' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, StaticMeshBuildSettings) == 0x000A78, "Member 'UHoudiniAssetComponent::StaticMeshBuildSettings' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bOverrideGlobalProxyStaticMeshSettings) == 0x000AC0, "Member 'UHoudiniAssetComponent::bOverrideGlobalProxyStaticMeshSettings' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableProxyStaticMeshOverride) == 0x000AC1, "Member 'UHoudiniAssetComponent::bEnableProxyStaticMeshOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableProxyStaticMeshRefinementByTimerOverride) == 0x000AC2, "Member 'UHoudiniAssetComponent::bEnableProxyStaticMeshRefinementByTimerOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, ProxyMeshAutoRefineTimeoutSecondsOverride) == 0x000AC4, "Member 'UHoudiniAssetComponent::ProxyMeshAutoRefineTimeoutSecondsOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableProxyStaticMeshRefinementOnPreSaveWorldOverride) == 0x000AC8, "Member 'UHoudiniAssetComponent::bEnableProxyStaticMeshRefinementOnPreSaveWorldOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableProxyStaticMeshRefinementOnPreBeginPIEOverride) == 0x000AC9, "Member 'UHoudiniAssetComponent::bEnableProxyStaticMeshRefinementOnPreBeginPIEOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bLandscapeUseTempLayers) == 0x000ACA, "Member 'UHoudiniAssetComponent::bLandscapeUseTempLayers' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetId) == 0x000ACC, "Member 'UHoudiniAssetComponent::AssetId' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, NodeIdsToCook) == 0x000AD0, "Member 'UHoudiniAssetComponent::NodeIdsToCook' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, OutputNodeCookCounts) == 0x000AE0, "Member 'UHoudiniAssetComponent::OutputNodeCookCounts' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, DownstreamHoudiniAssets) == 0x000B30, "Member 'UHoudiniAssetComponent::DownstreamHoudiniAssets' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, ComponentGUID) == 0x000B80, "Member 'UHoudiniAssetComponent::ComponentGUID' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, HapiGUID) == 0x000B90, "Member 'UHoudiniAssetComponent::HapiGUID' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, HapiAssetName) == 0x000BA0, "Member 'UHoudiniAssetComponent::HapiAssetName' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetState) == 0x000BB0, "Member 'UHoudiniAssetComponent::AssetState' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, DebugLastAssetState) == 0x000BB1, "Member 'UHoudiniAssetComponent::DebugLastAssetState' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetStateResult) == 0x000BB2, "Member 'UHoudiniAssetComponent::AssetStateResult' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, LastComponentTransform) == 0x000BC0, "Member 'UHoudiniAssetComponent::LastComponentTransform' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, SubAssetIndex) == 0x000C20, "Member 'UHoudiniAssetComponent::SubAssetIndex' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetCookCount) == 0x000C24, "Member 'UHoudiniAssetComponent::AssetCookCount' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasBeenLoaded) == 0x000C28, "Member 'UHoudiniAssetComponent::bHasBeenLoaded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasBeenDuplicated) == 0x000C29, "Member 'UHoudiniAssetComponent::bHasBeenDuplicated' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bPendingDelete) == 0x000C2A, "Member 'UHoudiniAssetComponent::bPendingDelete' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bRecookRequested) == 0x000C2B, "Member 'UHoudiniAssetComponent::bRecookRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bRebuildRequested) == 0x000C2C, "Member 'UHoudiniAssetComponent::bRebuildRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableCooking) == 0x000C2D, "Member 'UHoudiniAssetComponent::bEnableCooking' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bForceNeedUpdate) == 0x000C2E, "Member 'UHoudiniAssetComponent::bForceNeedUpdate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bLastCookSuccess) == 0x000C2F, "Member 'UHoudiniAssetComponent::bLastCookSuccess' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bParameterDefinitionUpdateNeeded) == 0x000C30, "Member 'UHoudiniAssetComponent::bParameterDefinitionUpdateNeeded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBlueprintStructureModified) == 0x000C31, "Member 'UHoudiniAssetComponent::bBlueprintStructureModified' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBlueprintModified) == 0x000C32, "Member 'UHoudiniAssetComponent::bBlueprintModified' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Parameters) == 0x000C38, "Member 'UHoudiniAssetComponent::Parameters' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Inputs) == 0x000C48, "Member 'UHoudiniAssetComponent::Inputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Outputs) == 0x000C58, "Member 'UHoudiniAssetComponent::Outputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, BakedOutputs) == 0x000C68, "Member 'UHoudiniAssetComponent::BakedOutputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, UntrackedOutputs) == 0x000C78, "Member 'UHoudiniAssetComponent::UntrackedOutputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, HandleComponents) == 0x000C88, "Member 'UHoudiniAssetComponent::HandleComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasComponentTransformChanged) == 0x000C98, "Member 'UHoudiniAssetComponent::bHasComponentTransformChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bFullyLoaded) == 0x000C99, "Member 'UHoudiniAssetComponent::bFullyLoaded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, PDGAssetLink) == 0x000CA0, "Member 'UHoudiniAssetComponent::PDGAssetLink' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, RefineMeshesTimer) == 0x000CA8, "Member 'UHoudiniAssetComponent::RefineMeshesTimer' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bNoProxyMeshNextCookRequested) == 0x000CD8, "Member 'UHoudiniAssetComponent::bNoProxyMeshNextCookRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, InputPresets) == 0x000CE0, "Member 'UHoudiniAssetComponent::InputPresets' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBakeAfterNextCook) == 0x000D30, "Member 'UHoudiniAssetComponent::bBakeAfterNextCook' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCachedIsPreview) == 0x000D90, "Member 'UHoudiniAssetComponent::bCachedIsPreview' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, LastTickTime) == 0x000DA0, "Member 'UHoudiniAssetComponent::LastTickTime' has a wrong offset!");
...
static_assert(sizeof(UHoudiniAssetBlueprintComponent) == 0x000EC0, "Wrong size on UHoudiniAssetBlueprintComponent");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, FauxBPProperty) == 0x000E08, "Member 'UHoudiniAssetBlueprintComponent::FauxBPProperty' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bHoudiniAssetChanged) == 0x000E09, "Member 'UHoudiniAssetBlueprintComponent::bHoudiniAssetChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bUpdatedFromTemplate) == 0x000E0A, "Member 'UHoudiniAssetBlueprintComponent::bUpdatedFromTemplate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bIsInBlueprintEditor) == 0x000E0B, "Member 'UHoudiniAssetBlueprintComponent::bIsInBlueprintEditor' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bCanDeleteHoudiniNodes) == 0x000E0C, "Member 'UHoudiniAssetBlueprintComponent::bCanDeleteHoudiniNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bHasRegisteredComponentTemplate) == 0x000E0D, "Member 'UHoudiniAssetBlueprintComponent::bHasRegisteredComponentTemplate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, CachedOutputNodes) == 0x000E18, "Member 'UHoudiniAssetBlueprintComponent::CachedOutputNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, CachedInputNodes) == 0x000E68, "Member 'UHoudiniAssetBlueprintComponent::CachedInputNodes' has a wrong offset!");
...
static_assert(sizeof(UHoudiniAssetComponent_V1) == 0x000DB0, "Wrong size on UHoudiniAssetComponent_V1");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedPhysMaterial) == 0x000840, "Member 'UHoudiniAssetComponent_V1::GeneratedPhysMaterial' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, DefaultBodyInstance) == 0x000848, "Member 'UHoudiniAssetComponent_V1::DefaultBodyInstance' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedCollisionTraceFlag) == 0x0009F8, "Member 'UHoudiniAssetComponent_V1::GeneratedCollisionTraceFlag' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedLightMapResolution) == 0x0009FC, "Member 'UHoudiniAssetComponent_V1::GeneratedLightMapResolution' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedDistanceFieldResolutionScale) == 0x000A00, "Member 'UHoudiniAssetComponent_V1::GeneratedDistanceFieldResolutionScale' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedWalkableSlopeOverride) == 0x000A04, "Member 'UHoudiniAssetComponent_V1::GeneratedWalkableSlopeOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedLightMapCoordinateIndex) == 0x000A14, "Member 'UHoudiniAssetComponent_V1::GeneratedLightMapCoordinateIndex' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedStreamingDistanceMultiplier) == 0x000A1C, "Member 'UHoudiniAssetComponent_V1::GeneratedStreamingDistanceMultiplier' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedFoliageDefaultSettings) == 0x000A20, "Member 'UHoudiniAssetComponent_V1::GeneratedFoliageDefaultSettings' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedAssetUserData) == 0x000A28, "Member 'UHoudiniAssetComponent_V1::GeneratedAssetUserData' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, BakeFolder) == 0x000A38, "Member 'UHoudiniAssetComponent_V1::BakeFolder' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, TempCookFolder) == 0x000A50, "Member 'UHoudiniAssetComponent_V1::TempCookFolder' has a wrong offset!");
...
static_assert(sizeof(UHoudiniStaticMeshComponent) == 0x0008F0, "Wrong size on UHoudiniStaticMeshComponent");
static_assert(offsetof(UHoudiniStaticMeshComponent, Mesh) == 0x0008A8, "Member 'UHoudiniStaticMeshComponent::Mesh' has a wrong offset!");
static_assert(offsetof(UHoudiniStaticMeshComponent, LocalBounds) == 0x0008B0, "Member 'UHoudiniStaticMeshComponent::LocalBounds' has a wrong offset!");
static_assert(offsetof(UHoudiniStaticMeshComponent, bHoudiniIconVisible) == 0x0008E8, "Member 'UHoudiniStaticMeshComponent::bHoudiniIconVisible' has a wrong offset!");
