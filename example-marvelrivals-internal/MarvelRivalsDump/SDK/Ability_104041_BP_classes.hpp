...
//static_assert(sizeof(UAbility_104041_BP_C) == 0x0027D0, "Wrong size on UAbility_104041_BP_C");
//static_assert(offsetof(UAbility_104041_BP_C, UberGraphFrame) == 0x0027C8, "Member 'UAbility_104041_BP_C::UberGraphFrame' has a wrong offset!");
