...
static_assert(sizeof(UPyWidget_Common_Bg) == 0x0005C8, "Wrong size on UPyWidget_Common_Bg");
static_assert(offsetof(UPyWidget_Common_Bg, Anim_Narrow_FadeIn) == 0x0005A8, "Member 'UPyWidget_Common_Bg::Anim_Narrow_FadeIn' has a wrong offset!");
static_assert(offsetof(UPyWidget_Common_Bg, Anim_Narrow_FadeOut) == 0x0005B0, "Member 'UPyWidget_Common_Bg::Anim_Narrow_FadeOut' has a wrong offset!");
static_assert(offsetof(UPyWidget_Common_Bg, Anim_NarrowFolw_FadeIn) == 0x0005B8, "Member 'UPyWidget_Common_Bg::Anim_NarrowFolw_FadeIn' has a wrong offset!");
static_assert(offsetof(UPyWidget_Common_Bg, Anim_NarrowFolw_Loop) == 0x0005C0, "Member 'UPyWidget_Common_Bg::Anim_NarrowFolw_Loop' has a wrong offset!");
