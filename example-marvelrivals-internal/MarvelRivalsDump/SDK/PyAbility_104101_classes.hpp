...
{
public:
	FMulticastInlineDelegateProperty_             OnPassiveAmmoAdd;                                  // 0x2580(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_104101) == 0x002590, "Wrong size on UPyAbility_104101");
static_assert(offsetof(UPyAbility_104101, OnPassiveAmmoAdd) == 0x002580, "Member 'UPyAbility_104101::OnPassiveAmmoAdd' has a wrong offset!");
...
static_assert(sizeof(UPyUIController_104101) == 0x000C60, "Wrong size on UPyUIController_104101");
