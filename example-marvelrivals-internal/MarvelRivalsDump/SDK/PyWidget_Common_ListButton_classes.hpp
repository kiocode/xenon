...
public:
	...
	FMulticastInlineDelegateProperty_             OnHoveredEvenSelected;                             // 0x0960(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUnhoveredEvenSelected;                           // 0x0970(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_CommonVXButton) == 0x000980, "Wrong size on UPyWidget_CommonVXButton");
static_assert(offsetof(UPyWidget_CommonVXButton, Size) == 0x0008E8, "Member 'UPyWidget_CommonVXButton::Size' has a wrong offset!");
static_assert(offsetof(UPyWidget_CommonVXButton, NormalFontColor) == 0x0008F8, "Member 'UPyWidget_CommonVXButton::NormalFontColor' has a wrong offset!");
static_assert(offsetof(UPyWidget_CommonVXButton, HoverFontColor) == 0x00090C, "Member 'UPyWidget_CommonVXButton::HoverFontColor' has a wrong offset!");
static_assert(offsetof(UPyWidget_CommonVXButton, SelectedFontColor) == 0x000920, "Member 'UPyWidget_CommonVXButton::SelectedFontColor' has a wrong offset!");
static_assert(offsetof(UPyWidget_CommonVXButton, UnSelectedIconColor) == 0x000934, "Member 'UPyWidget_CommonVXButton::UnSelectedIconColor' has a wrong offset!");
static_assert(offsetof(UPyWidget_CommonVXButton, SelectedIconColor) == 0x000948, "Member 'UPyWidget_CommonVXButton::SelectedIconColor' has a wrong offset!");
static_assert(offsetof(UPyWidget_CommonVXButton, OnHoveredEvenSelected) == 0x000960, "Member 'UPyWidget_CommonVXButton::OnHoveredEvenSelected' has a wrong offset!");
static_assert(offsetof(UPyWidget_CommonVXButton, OnUnhoveredEvenSelected) == 0x000970, "Member 'UPyWidget_CommonVXButton::OnUnhoveredEvenSelected' has a wrong offset!");
...
static_assert(sizeof(UPyWidget_CommonVXButtonLVX) == 0x000980, "Wrong size on UPyWidget_CommonVXButtonLVX");
...
static_assert(sizeof(UPyWidget_CommonVXButtonV3) == 0x000980, "Wrong size on UPyWidget_CommonVXButtonV3");
