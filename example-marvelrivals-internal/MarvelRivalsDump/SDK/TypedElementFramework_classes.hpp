...
//static_assert(sizeof(ITypedElementDataStorageCompatibilityInterface) == 0x000030, "Wrong size on ITypedElementDataStorageCompatibilityInterface");
...
//static_assert(sizeof(ITypedElementDataStorageInterface) == 0x000030, "Wrong size on ITypedElementDataStorageInterface");
...
//static_assert(sizeof(ITypedElementDataStorageUiInterface) == 0x000030, "Wrong size on ITypedElementDataStorageUiInterface");
...
//static_assert(sizeof(ITypedElementCounterInterface) == 0x000030, "Wrong size on ITypedElementCounterInterface");
...
//static_assert(sizeof(ITestTypedElementInterfaceA) == 0x000030, "Wrong size on ITestTypedElementInterfaceA");
...
//static_assert(sizeof(ITestTypedElementInterfaceB) == 0x000030, "Wrong size on ITestTypedElementInterfaceB");
...
//static_assert(sizeof(ITestTypedElementInterfaceC) == 0x000030, "Wrong size on ITestTypedElementInterfaceC");
