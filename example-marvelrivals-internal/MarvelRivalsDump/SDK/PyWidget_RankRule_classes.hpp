...
static_assert(sizeof(UPyWidget_RankRulePanel) == 0x0005F8, "Wrong size on UPyWidget_RankRulePanel");
static_assert(offsetof(UPyWidget_RankRulePanel, Class_InactiveWarningToolTip) == 0x0005F0, "Member 'UPyWidget_RankRulePanel::Class_InactiveWarningToolTip' has a wrong offset!");
