...
////static_assert(sizeof(UWBP_DebugAudio_C) == 0x000808, "Wrong size on UWBP_DebugAudio_C");
////static_assert(offsetof(UWBP_DebugAudio_C, UberGraphFrame) == 0x0005F0, "Member 'UWBP_DebugAudio_C::UberGraphFrame' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Btn_Expression) == 0x0005F8, "Member 'UWBP_DebugAudio_C::Btn_Expression' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Btn_SwitchAbility) == 0x000600, "Member 'UWBP_DebugAudio_C::Btn_SwitchAbility' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Btn_SwitchProcedure) == 0x000608, "Member 'UWBP_DebugAudio_C::Btn_SwitchProcedure' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, ExpressionContent) == 0x000610, "Member 'UWBP_DebugAudio_C::ExpressionContent' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, LockThreatButton) == 0x000618, "Member 'UWBP_DebugAudio_C::LockThreatButton' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, LockThreatInput) == 0x000620, "Member 'UWBP_DebugAudio_C::LockThreatInput' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_DebugInfo) == 0x000628, "Member 'UWBP_DebugAudio_C::Text_DebugInfo' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_SpatialVolume) == 0x000630, "Member 'UWBP_DebugAudio_C::Text_SpatialVolume' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_00Hero) == 0x000638, "Member 'UWBP_DebugAudio_C::TV_00Hero' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_00Name) == 0x000640, "Member 'UWBP_DebugAudio_C::TV_00Name' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_01Value) == 0x000648, "Member 'UWBP_DebugAudio_C::TV_01Value' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_02Enemy) == 0x000650, "Member 'UWBP_DebugAudio_C::TV_02Enemy' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_03Dist) == 0x000658, "Member 'UWBP_DebugAudio_C::TV_03Dist' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_04View) == 0x000660, "Member 'UWBP_DebugAudio_C::TV_04View' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_05Aim) == 0x000668, "Member 'UWBP_DebugAudio_C::TV_05Aim' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_05Back) == 0x000670, "Member 'UWBP_DebugAudio_C::TV_05Back' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_06Block) == 0x000678, "Member 'UWBP_DebugAudio_C::TV_06Block' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_07Fire) == 0x000680, "Member 'UWBP_DebugAudio_C::TV_07Fire' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_08Damage) == 0x000688, "Member 'UWBP_DebugAudio_C::TV_08Damage' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_09Buff) == 0x000690, "Member 'UWBP_DebugAudio_C::TV_09Buff' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_10Ultimate) == 0x000698, "Member 'UWBP_DebugAudio_C::TV_10Ultimate' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TV_11Weight) == 0x0006A0, "Member 'UWBP_DebugAudio_C::TV_11Weight' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, UnlockAllThreatButton) == 0x0006A8, "Member 'UWBP_DebugAudio_C::UnlockAllThreatButton' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, UnlockThreatButton) == 0x0006B0, "Member 'UWBP_DebugAudio_C::UnlockThreatButton' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, VoiceUiPanel) == 0x0006B8, "Member 'UWBP_DebugAudio_C::VoiceUiPanel' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, WBP_DebugAudioAbility) == 0x0006C0, "Member 'UWBP_DebugAudio_C::WBP_DebugAudioAbility' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, WBP_DebugAudioTrigger) == 0x0006C8, "Member 'UWBP_DebugAudio_C::WBP_DebugAudioTrigger' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, WBP_DebugProcedureAudio) == 0x0006D0, "Member 'UWBP_DebugAudio_C::WBP_DebugProcedureAudio' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, WBP_HeroVoiceLines) == 0x0006D8, "Member 'UWBP_DebugAudio_C::WBP_HeroVoiceLines' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, WBP_UIEventLines) == 0x0006E0, "Member 'UWBP_DebugAudio_C::WBP_UIEventLines' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, TimeSinceLastUpdate) == 0x0006E8, "Member 'UWBP_DebugAudio_C::TimeSinceLastUpdate' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, LN) == 0x0006F0, "Member 'UWBP_DebugAudio_C::LN' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_00Hero) == 0x000700, "Member 'UWBP_DebugAudio_C::Text_00Hero' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_00Name) == 0x000710, "Member 'UWBP_DebugAudio_C::Text_00Name' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_01Value) == 0x000720, "Member 'UWBP_DebugAudio_C::Text_01Value' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_02Enemy) == 0x000730, "Member 'UWBP_DebugAudio_C::Text_02Enemy' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_03Dist) == 0x000740, "Member 'UWBP_DebugAudio_C::Text_03Dist' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_04View) == 0x000750, "Member 'UWBP_DebugAudio_C::Text_04View' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_05Aim) == 0x000760, "Member 'UWBP_DebugAudio_C::Text_05Aim' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_05Back) == 0x000770, "Member 'UWBP_DebugAudio_C::Text_05Back' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_06Block) == 0x000780, "Member 'UWBP_DebugAudio_C::Text_06Block' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_07Fire) == 0x000790, "Member 'UWBP_DebugAudio_C::Text_07Fire' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_08Damage) == 0x0007A0, "Member 'UWBP_DebugAudio_C::Text_08Damage' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_09Buff) == 0x0007B0, "Member 'UWBP_DebugAudio_C::Text_09Buff' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_10Ultimate) == 0x0007C0, "Member 'UWBP_DebugAudio_C::Text_10Ultimate' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, Text_11Weight) == 0x0007D0, "Member 'UWBP_DebugAudio_C::Text_11Weight' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, ThreatAdmin) == 0x0007E0, "Member 'UWBP_DebugAudio_C::ThreatAdmin' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, SwitchValue) == 0x0007E8, "Member 'UWBP_DebugAudio_C::SwitchValue' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, bNewCmdPanelVisible) == 0x0007EC, "Member 'UWBP_DebugAudio_C::bNewCmdPanelVisible' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, OldCmdNames) == 0x0007F0, "Member 'UWBP_DebugAudio_C::OldCmdNames' has a wrong offset!");
////static_assert(offsetof(UWBP_DebugAudio_C, CachedDestructionActor) == 0x000800, "Member 'UWBP_DebugAudio_C::CachedDestructionActor' has a wrong offset!");
