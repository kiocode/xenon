...
static_assert(sizeof(FGroomCacheImportSettings) == 0x000070, "Wrong size on FGroomCacheImportSettings");
...
static_assert(offsetof(FGroomCacheImportSettings, bOverrideConversionSettings) == 0x000038, "Member 'FGroomCacheImportSettings::bOverrideConversionSettings' has a wrong offset!");
static_assert(offsetof(FGroomCacheImportSettings, ConversionSettings) == 0x000040, "Member 'FGroomCacheImportSettings::ConversionSettings' has a wrong offset!");
...
static_assert(sizeof(FHairGroupsMeshesSourceDescription) == 0x000070, "Wrong size on FHairGroupsMeshesSourceDescription");
...
static_assert(offsetof(FHairGroupsMeshesSourceDescription, ImportedMesh) == 0x000018, "Member 'FHairGroupsMeshesSourceDescription::ImportedMesh' has a wrong offset!");
static_assert(offsetof(FHairGroupsMeshesSourceDescription, Textures) == 0x000020, "Member 'FHairGroupsMeshesSourceDescription::Textures' has a wrong offset!");
static_assert(offsetof(FHairGroupsMeshesSourceDescription, GroupIndex) == 0x000058, "Member 'FHairGroupsMeshesSourceDescription::GroupIndex' has a wrong offset!");
static_assert(offsetof(FHairGroupsMeshesSourceDescription, LODIndex) == 0x00005C, "Member 'FHairGroupsMeshesSourceDescription::LODIndex' has a wrong offset!");
static_assert(offsetof(FHairGroupsMeshesSourceDescription, ImportedMeshKey) == 0x000060, "Member 'FHairGroupsMeshesSourceDescription::ImportedMeshKey' has a wrong offset!");
...
static_assert(sizeof(FHairGroupInfo) == 0x000040, "Wrong size on FHairGroupInfo");
...
static_assert(offsetof(FHairGroupInfo, NumCurves) == 0x000010, "Member 'FHairGroupInfo::NumCurves' has a wrong offset!");
static_assert(offsetof(FHairGroupInfo, NumGuides) == 0x000014, "Member 'FHairGroupInfo::NumGuides' has a wrong offset!");
static_assert(offsetof(FHairGroupInfo, NumCurveVertices) == 0x000018, "Member 'FHairGroupInfo::NumCurveVertices' has a wrong offset!");
static_assert(offsetof(FHairGroupInfo, NumGuideVertices) == 0x00001C, "Member 'FHairGroupInfo::NumGuideVertices' has a wrong offset!");
static_assert(offsetof(FHairGroupInfo, MaxCurveLength) == 0x000020, "Member 'FHairGroupInfo::MaxCurveLength' has a wrong offset!");
static_assert(offsetof(FHairGroupInfo, GroupCardsID) == 0x000024, "Member 'FHairGroupInfo::GroupCardsID' has a wrong offset!");
static_assert(offsetof(FHairGroupInfo, Flags) == 0x000028, "Member 'FHairGroupInfo::Flags' has a wrong offset!");
static_assert(offsetof(FHairGroupInfo, LODInfos) == 0x000030, "Member 'FHairGroupInfo::LODInfos' has a wrong offset!");
...
static_assert(sizeof(FHairGroupsMaterial) == 0x000018, "Wrong size on FHairGroupsMaterial");
...
static_assert(sizeof(FHairGroupInfoWithVisibility) == 0x000048, "Wrong size on FHairGroupInfoWithVisibility");
static_assert(offsetof(FHairGroupInfoWithVisibility, bIsVisible) == 0x000040, "Member 'FHairGroupInfoWithVisibility::bIsVisible' has a wrong offset!");
...
static_assert(offsetof(FHairSolverSettings, bForceVisible) == 0x000044, "Member 'FHairSolverSettings::bForceVisible' has a wrong offset!");
...
static_assert(offsetof(FHairGroupsCardsSourceDescription, SourceType) == 0x000014, "Member 'FHairGroupsCardsSourceDescription::SourceType' has a wrong offset!");
...
static_assert(sizeof(FHairGroupsRendering) == 0x000038, "Wrong size on FHairGroupsRendering");
...
static_assert(offsetof(FHairGroupsRendering, Material) == 0x000010, "Member 'FHairGroupsRendering::Material' has a wrong offset!");
static_assert(offsetof(FHairGroupsRendering, GeometrySettings) == 0x000018, "Member 'FHairGroupsRendering::GeometrySettings' has a wrong offset!");
static_assert(offsetof(FHairGroupsRendering, ShadowSettings) == 0x000028, "Member 'FHairGroupsRendering::ShadowSettings' has a wrong offset!");
static_assert(offsetof(FHairGroupsRendering, AdvancedSettings) == 0x000034, "Member 'FHairGroupsRendering::AdvancedSettings' has a wrong offset!");
...
static_assert(offsetof(FGroomHairGroupPreview, GroupId) == 0x00000C, "Member 'FGroomHairGroupPreview::GroupId' has a wrong offset!");
static_assert(offsetof(FGroomHairGroupPreview, CurveCount) == 0x000010, "Member 'FGroomHairGroupPreview::CurveCount' has a wrong offset!");
static_assert(offsetof(FGroomHairGroupPreview, GuideCount) == 0x000014, "Member 'FGroomHairGroupPreview::GuideCount' has a wrong offset!");
static_assert(offsetof(FGroomHairGroupPreview, Attributes) == 0x000018, "Member 'FGroomHairGroupPreview::Attributes' has a wrong offset!");
static_assert(offsetof(FGroomHairGroupPreview, AttributeFlags) == 0x00001C, "Member 'FGroomHairGroupPreview::AttributeFlags' has a wrong offset!");
static_assert(offsetof(FGroomHairGroupPreview, Flags) == 0x000020, "Member 'FGroomHairGroupPreview::Flags' has a wrong offset!");
static_assert(offsetof(FGroomHairGroupPreview, InterpolationSettings) == 0x000024, "Member 'FGroomHairGroupPreview::InterpolationSettings' has a wrong offset!");
