...
static_assert(sizeof(UPyConfig_105071) == 0x0010D0, "Wrong size on UPyConfig_105071");
static_assert(offsetof(UPyConfig_105071, TraceParams) == 0x0000F0, "Member 'UPyConfig_105071::TraceParams' has a wrong offset!");
static_assert(offsetof(UPyConfig_105071, PlacementCueTag) == 0x0010C0, "Member 'UPyConfig_105071::PlacementCueTag' has a wrong offset!");
static_assert(offsetof(UPyConfig_105071, AbilityEndStage) == 0x0010CC, "Member 'UPyConfig_105071::AbilityEndStage' has a wrong offset!");
...
static_assert(sizeof(UPyAbility_105071) == 0x002628, "Wrong size on UPyAbility_105071");
...
static_assert(sizeof(APyCue_TraceActor_105071) == 0x000D10, "Wrong size on APyCue_TraceActor_105071");
static_assert(offsetof(APyCue_TraceActor_105071, ObjectHeightName) == 0x000D00, "Member 'APyCue_TraceActor_105071::ObjectHeightName' has a wrong offset!");
...
static_assert(sizeof(APyCueNotify_Buff_10507101) == 0x001048, "Wrong size on APyCueNotify_Buff_10507101");
static_assert(offsetof(APyCueNotify_Buff_10507101, TeamateStartAudioID) == 0x001038, "Member 'APyCueNotify_Buff_10507101::TeamateStartAudioID' has a wrong offset!");
static_assert(offsetof(APyCueNotify_Buff_10507101, TeamateEndAudioID) == 0x00103C, "Member 'APyCueNotify_Buff_10507101::TeamateEndAudioID' has a wrong offset!");
static_assert(offsetof(APyCueNotify_Buff_10507101, EnemyStartAudioID) == 0x001040, "Member 'APyCueNotify_Buff_10507101::EnemyStartAudioID' has a wrong offset!");
static_assert(offsetof(APyCueNotify_Buff_10507101, EnemyEndAudioID) == 0x001044, "Member 'APyCueNotify_Buff_10507101::EnemyEndAudioID' has a wrong offset!");
