...
////static_assert(sizeof(UAbility_103231_BP_C) == 0x0025A0, "Wrong size on UAbility_103231_BP_C");
////static_assert(offsetof(UAbility_103231_BP_C, UberGraphFrame) == 0x002598, "Member 'UAbility_103231_BP_C::UberGraphFrame' has a wrong offset!");
