...
//static_assert(sizeof(UAbility_103931_BP_C) == 0x002638, "Wrong size on UAbility_103931_BP_C");
//static_assert(offsetof(UAbility_103931_BP_C, UberGraphFrame) == 0x002630, "Member 'UAbility_103931_BP_C::UberGraphFrame' has a wrong offset!");
