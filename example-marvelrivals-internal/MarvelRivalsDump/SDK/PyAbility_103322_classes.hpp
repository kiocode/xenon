...
static_assert(sizeof(UPyAbility_103322) == 0x0026A0, "Wrong size on UPyAbility_103322");
static_assert(offsetof(UPyAbility_103322, SniperRifleID) == 0x002698, "Member 'UPyAbility_103322::SniperRifleID' has a wrong offset!");
static_assert(offsetof(UPyAbility_103322, LoadBulletAbilityID) == 0x00269C, "Member 'UPyAbility_103322::LoadBulletAbilityID' has a wrong offset!");
