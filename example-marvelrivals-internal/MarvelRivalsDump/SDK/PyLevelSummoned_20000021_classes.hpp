...
static_assert(sizeof(UPyCommonOverlapHandlerComponent) == 0x000C30, "Wrong size on UPyCommonOverlapHandlerComponent");
...
static_assert(sizeof(APyLevelSummoned_20000021) == 0x0008F0, "Wrong size on APyLevelSummoned_20000021");
static_assert(offsetof(APyLevelSummoned_20000021, BattleSide) == 0x0008C0, "Member 'APyLevelSummoned_20000021::BattleSide' has a wrong offset!");
static_assert(offsetof(APyLevelSummoned_20000021, PickUpUID) == 0x0008C4, "Member 'APyLevelSummoned_20000021::PickUpUID' has a wrong offset!");
static_assert(offsetof(APyLevelSummoned_20000021, bIsLanded) == 0x0008C8, "Member 'APyLevelSummoned_20000021::bIsLanded' has a wrong offset!");
static_assert(offsetof(APyLevelSummoned_20000021, bIsLaunched) == 0x0008C9, "Member 'APyLevelSummoned_20000021::bIsLaunched' has a wrong offset!");
static_assert(offsetof(APyLevelSummoned_20000021, InitialVelocity) == 0x0008D0, "Member 'APyLevelSummoned_20000021::InitialVelocity' has a wrong offset!");
...
static_assert(sizeof(APyCue_Summoner_Loop_20030001_BP) == 0x000E90, "Wrong size on APyCue_Summoner_Loop_20030001_BP");
...
static_assert(sizeof(UPyOverlapHandlerComponent_20000021) == 0x000C30, "Wrong size on UPyOverlapHandlerComponent_20000021");
...
static_assert(sizeof(APyLevelSummoned_20000022) == 0x0008F0, "Wrong size on APyLevelSummoned_20000022");
static_assert(offsetof(APyLevelSummoned_20000022, AppearFX) == 0x0008C0, "Member 'APyLevelSummoned_20000022::AppearFX' has a wrong offset!");
static_assert(offsetof(APyLevelSummoned_20000022, ReleaseFX) == 0x0008C8, "Member 'APyLevelSummoned_20000022::ReleaseFX' has a wrong offset!");
static_assert(offsetof(APyLevelSummoned_20000022, Velocity) == 0x0008D0, "Member 'APyLevelSummoned_20000022::Velocity' has a wrong offset!");
...
static_assert(sizeof(UPySummonedComp_20000021) == 0x000CB0, "Wrong size on UPySummonedComp_20000021");
static_assert(offsetof(UPySummonedComp_20000021, AbilityCollisionType) == 0x000CA0, "Member 'UPySummonedComp_20000021::AbilityCollisionType' has a wrong offset!");
