...
//static_assert(sizeof(UWBP_Battle_HeroHead_C) == 0x0005E0, "Wrong size on UWBP_Battle_HeroHead_C");
//static_assert(offsetof(UWBP_Battle_HeroHead_C, Anim_Faction) == 0x0005B0, "Member 'UWBP_Battle_HeroHead_C::Anim_Faction' has a wrong offset!");
//static_assert(offsetof(UWBP_Battle_HeroHead_C, Bg_PortaitBg) == 0x0005B8, "Member 'UWBP_Battle_HeroHead_C::Bg_PortaitBg' has a wrong offset!");
//static_assert(offsetof(UWBP_Battle_HeroHead_C, Bg_PortaitBg_LeftTop) == 0x0005C0, "Member 'UWBP_Battle_HeroHead_C::Bg_PortaitBg_LeftTop' has a wrong offset!");
//static_assert(offsetof(UWBP_Battle_HeroHead_C, Bg_PortaitBg_RightBottom) == 0x0005C8, "Member 'UWBP_Battle_HeroHead_C::Bg_PortaitBg_RightBottom' has a wrong offset!");
//static_assert(offsetof(UWBP_Battle_HeroHead_C, Bg_PortaitFrame) == 0x0005D0, "Member 'UWBP_Battle_HeroHead_C::Bg_PortaitFrame' has a wrong offset!");
//static_assert(offsetof(UWBP_Battle_HeroHead_C, Img_Portrait) == 0x0005D8, "Member 'UWBP_Battle_HeroHead_C::Img_Portrait' has a wrong offset!");
