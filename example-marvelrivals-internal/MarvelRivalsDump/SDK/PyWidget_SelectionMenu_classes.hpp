...
static_assert(sizeof(UPyWidget_SelectionMenu) == 0x000638, "Wrong size on UPyWidget_SelectionMenu");
static_assert(offsetof(UPyWidget_SelectionMenu, AkEvent_OnShowMenu) == 0x000618, "Member 'UPyWidget_SelectionMenu::AkEvent_OnShowMenu' has a wrong offset!");
static_assert(offsetof(UPyWidget_SelectionMenu, MenuOffset) == 0x000620, "Member 'UPyWidget_SelectionMenu::MenuOffset' has a wrong offset!");
static_assert(offsetof(UPyWidget_SelectionMenu, SelectionUnitClass) == 0x000630, "Member 'UPyWidget_SelectionMenu::SelectionUnitClass' has a wrong offset!");
