...
static_assert(sizeof(UComputeGraphComponent) == 0x000110, "Wrong size on UComputeGraphComponent");
static_assert(offsetof(UComputeGraphComponent, ComputeGraph) == 0x0000F0, "Member 'UComputeGraphComponent::ComputeGraph' has a wrong offset!");
static_assert(offsetof(UComputeGraphComponent, ComputeGraphInstance) == 0x0000F8, "Member 'UComputeGraphComponent::ComputeGraphInstance' has a wrong offset!");
