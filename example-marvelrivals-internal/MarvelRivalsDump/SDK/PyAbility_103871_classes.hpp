...
static_assert(sizeof(UPyConfig_103871) == 0x001100, "Wrong size on UPyConfig_103871");
...
static_assert(sizeof(UPyAbility_103871) == 0x005C00, "Wrong size on UPyAbility_103871");
