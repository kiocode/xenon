...
static_assert(sizeof(IIKGoalCreatorInterface) == 0x000030, "Wrong size on IIKGoalCreatorInterface");
...
static_assert(sizeof(UIKRigComponent) == 0x000108, "Wrong size on UIKRigComponent");
