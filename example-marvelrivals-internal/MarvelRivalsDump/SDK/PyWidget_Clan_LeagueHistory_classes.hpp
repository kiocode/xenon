...
static_assert(sizeof(UPyWidget_Clan_LeagueHistory) == 0x000628, "Wrong size on UPyWidget_Clan_LeagueHistory");
static_assert(offsetof(UPyWidget_Clan_LeagueHistory, ImgNoFilter) == 0x000618, "Member 'UPyWidget_Clan_LeagueHistory::ImgNoFilter' has a wrong offset!");
static_assert(offsetof(UPyWidget_Clan_LeagueHistory, ImgFilter) == 0x000620, "Member 'UPyWidget_Clan_LeagueHistory::ImgFilter' has a wrong offset!");
