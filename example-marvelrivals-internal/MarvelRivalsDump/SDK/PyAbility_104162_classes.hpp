...
static_assert(sizeof(UPyAbility_104162) == 0x002588, "Wrong size on UPyAbility_104162");
static_assert(offsetof(UPyAbility_104162, ScopeActor) == 0x002580, "Member 'UPyAbility_104162::ScopeActor' has a wrong offset!");
