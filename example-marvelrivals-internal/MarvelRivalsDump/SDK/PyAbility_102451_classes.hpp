...
{
public:
	FMulticastInlineDelegateProperty_             OnHelaShiftTeleportDistance;                       // 0x2580(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_102451) == 0x002590, "Wrong size on UPyAbility_102451");
static_assert(offsetof(UPyAbility_102451, OnHelaShiftTeleportDistance) == 0x002580, "Member 'UPyAbility_102451::OnHelaShiftTeleportDistance' has a wrong offset!");
...
static_assert(sizeof(APyProjectile_10245101) == 0x003090, "Wrong size on APyProjectile_10245101");
