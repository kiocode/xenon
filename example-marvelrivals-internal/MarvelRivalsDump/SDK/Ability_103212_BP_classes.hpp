...
////static_assert(sizeof(UAbility_103212_BP_C) == 0x002750, "Wrong size on UAbility_103212_BP_C");
////static_assert(offsetof(UAbility_103212_BP_C, UberGraphFrame) == 0x002748, "Member 'UAbility_103212_BP_C::UberGraphFrame' has a wrong offset!");
