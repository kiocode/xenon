...
static_assert(sizeof(UPyAbility_102304) == 0x002598, "Wrong size on UPyAbility_102304");
...
static_assert(sizeof(UPyUIController_102304) == 0x000C60, "Wrong size on UPyUIController_102304");
