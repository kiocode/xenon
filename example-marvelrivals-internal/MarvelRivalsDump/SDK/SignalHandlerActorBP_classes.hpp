...
////static_assert(sizeof(ASignalHandlerActorBP_C) == 0x000888, "Wrong size on ASignalHandlerActorBP_C");
////static_assert(offsetof(ASignalHandlerActorBP_C, SignalWidgetComponent) == 0x000870, "Member 'ASignalHandlerActorBP_C::SignalWidgetComponent' has a wrong offset!");
////static_assert(offsetof(ASignalHandlerActorBP_C, Niagara) == 0x000878, "Member 'ASignalHandlerActorBP_C::Niagara' has a wrong offset!");
////static_assert(offsetof(ASignalHandlerActorBP_C, DefaultSceneRoot) == 0x000880, "Member 'ASignalHandlerActorBP_C::DefaultSceneRoot' has a wrong offset!");
