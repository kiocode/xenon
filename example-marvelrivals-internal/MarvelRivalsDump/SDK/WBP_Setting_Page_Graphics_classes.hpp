...
////static_assert(sizeof(UWBP_Setting_Page_Graphics_C) == 0x000608, "Wrong size on UWBP_Setting_Page_Graphics_C");
////static_assert(offsetof(UWBP_Setting_Page_Graphics_C, VBox_Panel) == 0x000600, "Member 'UWBP_Setting_Page_Graphics_C::VBox_Panel' has a wrong offset!");
