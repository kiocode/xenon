...
////static_assert(sizeof(UWBP_GMCmd_EditorBox_C) == 0x000640, "Wrong size on UWBP_GMCmd_EditorBox_C");
////static_assert(offsetof(UWBP_GMCmd_EditorBox_C, Cmd_Editable) == 0x000600, "Member 'UWBP_GMCmd_EditorBox_C::Cmd_Editable' has a wrong offset!");
////static_assert(offsetof(UWBP_GMCmd_EditorBox_C, CmdName_Editable) == 0x000608, "Member 'UWBP_GMCmd_EditorBox_C::CmdName_Editable' has a wrong offset!");
////static_assert(offsetof(UWBP_GMCmd_EditorBox_C, CustomCmdBox) == 0x000610, "Member 'UWBP_GMCmd_EditorBox_C::CustomCmdBox' has a wrong offset!");
////static_assert(offsetof(UWBP_GMCmd_EditorBox_C, GroupName_Editable) == 0x000618, "Member 'UWBP_GMCmd_EditorBox_C::GroupName_Editable' has a wrong offset!");
////static_assert(offsetof(UWBP_GMCmd_EditorBox_C, TextBlock_Description) == 0x000620, "Member 'UWBP_GMCmd_EditorBox_C::TextBlock_Description' has a wrong offset!");
////static_assert(offsetof(UWBP_GMCmd_EditorBox_C, TextBlock_Description_1) == 0x000628, "Member 'UWBP_GMCmd_EditorBox_C::TextBlock_Description_1' has a wrong offset!");
////static_assert(offsetof(UWBP_GMCmd_EditorBox_C, TextBlock_Description_2) == 0x000630, "Member 'UWBP_GMCmd_EditorBox_C::TextBlock_Description_2' has a wrong offset!");
////static_assert(offsetof(UWBP_GMCmd_EditorBox_C, InputBoxClass) == 0x000638, "Member 'UWBP_GMCmd_EditorBox_C::InputBoxClass' has a wrong offset!");
