...
static_assert(sizeof(UPhantomInputSyncAbility) == 0x002598, "Wrong size on UPhantomInputSyncAbility");
static_assert(offsetof(UPhantomInputSyncAbility, Phantoms) == 0x002588, "Member 'UPhantomInputSyncAbility::Phantoms' has a wrong offset!");
...
static_assert(sizeof(APhantomSummonedController) == 0x000F60, "Wrong size on APhantomSummonedController");
static_assert(offsetof(APhantomSummonedController, bInvertRightMove) == 0x000A30, "Member 'APhantomSummonedController::bInvertRightMove' has a wrong offset!");
static_assert(offsetof(APhantomSummonedController, PhantomAimTargetFilter) == 0x000A38, "Member 'APhantomSummonedController::PhantomAimTargetFilter' has a wrong offset!");
static_assert(offsetof(APhantomSummonedController, PhantomAbilitySettings) == 0x000F38, "Member 'APhantomSummonedController::PhantomAbilitySettings' has a wrong offset!");
