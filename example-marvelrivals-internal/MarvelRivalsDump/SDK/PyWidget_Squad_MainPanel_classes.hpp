...
static_assert(sizeof(UPyWidget_Squad_MainPanel) == 0x000678, "Wrong size on UPyWidget_Squad_MainPanel");
static_assert(offsetof(UPyWidget_Squad_MainPanel, Overlay_SquadRecruit) == 0x000618, "Member 'UPyWidget_Squad_MainPanel::Overlay_SquadRecruit' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MainPanel, StartMatchStyles) == 0x000620, "Member 'UPyWidget_Squad_MainPanel::StartMatchStyles' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MainPanel, MoreModeStyles) == 0x000630, "Member 'UPyWidget_Squad_MainPanel::MoreModeStyles' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MainPanel, ViewMoreModeStyles) == 0x000640, "Member 'UPyWidget_Squad_MainPanel::ViewMoreModeStyles' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MainPanel, CancelMatchStyles) == 0x000650, "Member 'UPyWidget_Squad_MainPanel::CancelMatchStyles' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MainPanel, WBP_Squad_Open_Personnal_Panel_Press) == 0x000660, "Member 'UPyWidget_Squad_MainPanel::WBP_Squad_Open_Personnal_Panel_Press' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MainPanel, EmoteTip_Styles) == 0x000668, "Member 'UPyWidget_Squad_MainPanel::EmoteTip_Styles' has a wrong offset!");
...
static_assert(sizeof(UPyWidget_Squad_TrainingBtn) == 0x0005F0, "Wrong size on UPyWidget_Squad_TrainingBtn");
...
static_assert(sizeof(UPyWidget_Squad_Nameplate) == 0x000970, "Wrong size on UPyWidget_Squad_Nameplate");
static_assert(offsetof(UPyWidget_Squad_Nameplate, AKEvent_HoverAddPlayer) == 0x0008E8, "Member 'UPyWidget_Squad_Nameplate::AKEvent_HoverAddPlayer' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_Nameplate, AKEvent_ClickAddFriend) == 0x0008F0, "Member 'UPyWidget_Squad_Nameplate::AKEvent_ClickAddFriend' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_Nameplate, AkEvent_InvitationSucceeded) == 0x0008F8, "Member 'UPyWidget_Squad_Nameplate::AkEvent_InvitationSucceeded' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_Nameplate, MenuGuideTips) == 0x000900, "Member 'UPyWidget_Squad_Nameplate::MenuGuideTips' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_Nameplate, WBP_Nameplate) == 0x000910, "Member 'UPyWidget_Squad_Nameplate::WBP_Nameplate' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_Nameplate, Overlay_Empty) == 0x000918, "Member 'UPyWidget_Squad_Nameplate::Overlay_Empty' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_Nameplate, Overlay_Nameplate) == 0x000920, "Member 'UPyWidget_Squad_Nameplate::Overlay_Nameplate' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_Nameplate, Text_Score) == 0x000928, "Member 'UPyWidget_Squad_Nameplate::Text_Score' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_Nameplate, CanvasPanel_Hover) == 0x000930, "Member 'UPyWidget_Squad_Nameplate::CanvasPanel_Hover' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_Nameplate, Anim_Hover_FadeIn) == 0x000938, "Member 'UPyWidget_Squad_Nameplate::Anim_Hover_FadeIn' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_Nameplate, PlayerNameColor_Own) == 0x000940, "Member 'UPyWidget_Squad_Nameplate::PlayerNameColor_Own' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_Nameplate, PlayerNameColor_TeamMate) == 0x000954, "Member 'UPyWidget_Squad_Nameplate::PlayerNameColor_TeamMate' has a wrong offset!");
...
static_assert(sizeof(UPyWidget_Squad_SwitchHeroBtn) == 0x000638, "Wrong size on UPyWidget_Squad_SwitchHeroBtn");
static_assert(offsetof(UPyWidget_Squad_SwitchHeroBtn, Color_Hovered) == 0x0005EC, "Member 'UPyWidget_Squad_SwitchHeroBtn::Color_Hovered' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_SwitchHeroBtn, Color_Normal) == 0x000600, "Member 'UPyWidget_Squad_SwitchHeroBtn::Color_Normal' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_SwitchHeroBtn, Color_Pressed) == 0x000614, "Member 'UPyWidget_Squad_SwitchHeroBtn::Color_Pressed' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_SwitchHeroBtn, OnClicked) == 0x000628, "Member 'UPyWidget_Squad_SwitchHeroBtn::OnClicked' has a wrong offset!");
...
static_assert(sizeof(UPyWidget_Squad_BeginnerBtn) == 0x0005F0, "Wrong size on UPyWidget_Squad_BeginnerBtn");
