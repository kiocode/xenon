...
static_assert(sizeof(APyScarletWitchCharacter) == 0x001820, "Wrong size on APyScarletWitchCharacter");
...
static_assert(sizeof(APyScarletWitchChildActor) == 0x000B50, "Wrong size on APyScarletWitchChildActor");
static_assert(offsetof(APyScarletWitchChildActor, ReticleOpacityWhenForbidAttack) == 0x000B38, "Member 'APyScarletWitchChildActor::ReticleOpacityWhenForbidAttack' has a wrong offset!");
static_assert(offsetof(APyScarletWitchChildActor, FadeAbilityTags) == 0x000B40, "Member 'APyScarletWitchChildActor::FadeAbilityTags' has a wrong offset!");
