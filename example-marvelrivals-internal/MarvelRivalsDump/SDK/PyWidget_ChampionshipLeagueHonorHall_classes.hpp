...
static_assert(offsetof(UPyWidget_ChampionshipLeagueHonorHall, ImgNoFilter) == 0x000618, "Member 'UPyWidget_ChampionshipLeagueHonorHall::ImgNoFilter' has a wrong offset!");
static_assert(offsetof(UPyWidget_ChampionshipLeagueHonorHall, ImgFilter) == 0x000620, "Member 'UPyWidget_ChampionshipLeagueHonorHall::ImgFilter' has a wrong offset!");
