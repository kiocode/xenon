...
static_assert(sizeof(UPyWC_DebugInfo) == 0x000A30, "Wrong size on UPyWC_DebugInfo");
static_assert(offsetof(UPyWC_DebugInfo, Offset_Z) == 0x000A20, "Member 'UPyWC_DebugInfo::Offset_Z' has a wrong offset!");
static_assert(offsetof(UPyWC_DebugInfo, Summoned_Offset_Z) == 0x000A24, "Member 'UPyWC_DebugInfo::Summoned_Offset_Z' has a wrong offset!");
