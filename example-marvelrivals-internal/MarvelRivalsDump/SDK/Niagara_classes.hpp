...
public:
	...
	FMulticastInlineDelegateProperty_             OnSystemFinished;                                  // 0x0970(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnNoParticlesTimeReached;                          // 0x0980(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraComponent) == 0x000B70, "Wrong size on UNiagaraComponent");
static_assert(offsetof(UNiagaraComponent, Asset) == 0x000838, "Member 'UNiagaraComponent::Asset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, TickBehavior) == 0x000840, "Member 'UNiagaraComponent::TickBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, RandomSeedOffset) == 0x000844, "Member 'UNiagaraComponent::RandomSeedOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x000848, "Member 'UNiagaraComponent::OverrideParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, WarmupTickCount) == 0x00092C, "Member 'UNiagaraComponent::WarmupTickCount' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, WarmupTickDelta) == 0x000930, "Member 'UNiagaraComponent::WarmupTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OcclusionQueryMode) == 0x00096D, "Member 'UNiagaraComponent::OcclusionQueryMode' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OnSystemFinished) == 0x000970, "Member 'UNiagaraComponent::OnSystemFinished' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OnNoParticlesTimeReached) == 0x000980, "Member 'UNiagaraComponent::OnNoParticlesTimeReached' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachParent) == 0x000990, "Member 'UNiagaraComponent::AutoAttachParent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachSocketName) == 0x000998, "Member 'UNiagaraComponent::AutoAttachSocketName' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x0009A4, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x0009A5, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x0009A6, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, SimCache) == 0x000AE8, "Member 'UNiagaraComponent::SimCache' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, CullProxy) == 0x000AF0, "Member 'UNiagaraComponent::CullProxy' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, SystemLastTime) == 0x000AF8, "Member 'UNiagaraComponent::SystemLastTime' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameterCollectionInstances) == 0x000B20, "Member 'UNiagaraComponent::OverrideParameterCollectionInstances' has a wrong offset!");
...
static_assert(sizeof(ANiagaraActor) == 0x0004A0, "Wrong size on ANiagaraActor");
static_assert(offsetof(ANiagaraActor, NiagaraComponent) == 0x000490, "Member 'ANiagaraActor::NiagaraComponent' has a wrong offset!");
...
static_assert(sizeof(ANiagaraLensEffectBase) == 0x000530, "Wrong size on ANiagaraLensEffectBase");
static_assert(offsetof(ANiagaraLensEffectBase, DesiredRelativeTransform) == 0x0004B0, "Member 'ANiagaraLensEffectBase::DesiredRelativeTransform' has a wrong offset!");
static_assert(offsetof(ANiagaraLensEffectBase, BaseAuthoredFOV) == 0x000510, "Member 'ANiagaraLensEffectBase::BaseAuthoredFOV' has a wrong offset!");
static_assert(offsetof(ANiagaraLensEffectBase, EmittersToTreatAsSame) == 0x000518, "Member 'ANiagaraLensEffectBase::EmittersToTreatAsSame' has a wrong offset!");
static_assert(offsetof(ANiagaraLensEffectBase, OwningCameraManager) == 0x000528, "Member 'ANiagaraLensEffectBase::OwningCameraManager' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceCombineTriggerFX) == 0x0000B8, "Wrong size on UNiagaraDataInterfaceCombineTriggerFX");
...
static_assert(sizeof(UNiagaraDataInterfaceDynamicBatchMeshBase) == 0x000080, "Wrong size on UNiagaraDataInterfaceDynamicBatchMeshBase");
...
static_assert(sizeof(UNiagaraCullProxyComponent) == 0x000B80, "Wrong size on UNiagaraCullProxyComponent");
static_assert(offsetof(UNiagaraCullProxyComponent, Instances) == 0x000B70, "Member 'UNiagaraCullProxyComponent::Instances' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDecalRendererProperties) == 0x000390, "Wrong size on UNiagaraDecalRendererProperties");
...
static_assert(offsetof(UNiagaraDecalRendererProperties, MaterialParameters) == 0x000308, "Member 'UNiagaraDecalRendererProperties::MaterialParameters' has a wrong offset!");
...
static_assert(sizeof(ANiagaraPerfBaselineActor) == 0x0004A0, "Wrong size on ANiagaraPerfBaselineActor");
static_assert(offsetof(ANiagaraPerfBaselineActor, Controller) == 0x000490, "Member 'ANiagaraPerfBaselineActor::Controller' has a wrong offset!");
static_assert(offsetof(ANiagaraPerfBaselineActor, Label) == 0x000498, "Member 'ANiagaraPerfBaselineActor::Label' has a wrong offset!");
...
static_assert(sizeof(ANiagaraPreviewBase) == 0x000490, "Wrong size on ANiagaraPreviewBase");
...
static_assert(sizeof(ANiagaraPreviewGrid) == 0x0004E0, "Wrong size on ANiagaraPreviewGrid");
static_assert(offsetof(ANiagaraPreviewGrid, System) == 0x000490, "Member 'ANiagaraPreviewGrid::System' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, ResetMode) == 0x000498, "Member 'ANiagaraPreviewGrid::ResetMode' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisX) == 0x0004A0, "Member 'ANiagaraPreviewGrid::PreviewAxisX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisY) == 0x0004A8, "Member 'ANiagaraPreviewGrid::PreviewAxisY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewClass) == 0x0004B0, "Member 'ANiagaraPreviewGrid::PreviewClass' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, SpacingX) == 0x0004B8, "Member 'ANiagaraPreviewGrid::SpacingX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, SpacingY) == 0x0004BC, "Member 'ANiagaraPreviewGrid::SpacingY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, NumX) == 0x0004C0, "Member 'ANiagaraPreviewGrid::NumX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, NumY) == 0x0004C4, "Member 'ANiagaraPreviewGrid::NumY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewComponents) == 0x0004C8, "Member 'ANiagaraPreviewGrid::PreviewComponents' has a wrong offset!");
