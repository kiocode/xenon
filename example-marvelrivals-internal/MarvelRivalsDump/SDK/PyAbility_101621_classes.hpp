...
static_assert(sizeof(APyCue_Projectile_Loop_10162101) == 0x000DB0, "Wrong size on APyCue_Projectile_Loop_10162101");
...
static_assert(sizeof(APyProjectile_10162101) == 0x003070, "Wrong size on APyProjectile_10162101");
...
{
public:
	FMulticastInlineDelegateProperty_             OnSourceCharacterProjectileSuccess;                // 0x2580(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_101621) == 0x002590, "Wrong size on UPyAbility_101621");
static_assert(offsetof(UPyAbility_101621, OnSourceCharacterProjectileSuccess) == 0x002580, "Member 'UPyAbility_101621::OnSourceCharacterProjectileSuccess' has a wrong offset!");
