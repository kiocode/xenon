...
static_assert(sizeof(LegacyCameraShake_BlueprintUpdateCameraShake) == 0x0014B0, "Wrong size on LegacyCameraShake_BlueprintUpdateCameraShake");
...
static_assert(offsetof(LegacyCameraShake_BlueprintUpdateCameraShake, ModifiedPOV) == 0x000A60, "Member 'LegacyCameraShake_BlueprintUpdateCameraShake::ModifiedPOV' has a wrong offset!");
