...
//static_assert(sizeof(AnimationStateMachineLibrary_GetState) == 0x000030, "Wrong size on AnimationStateMachineLibrary_GetState");
...
//static_assert(sizeof(AnimationStateMachineLibrary_SetState) == 0x000050, "Wrong size on AnimationStateMachineLibrary_SetState");
...
//static_assert(offsetof(AnimationStateMachineLibrary_SetState, Duration) == 0x00002C, "Member 'AnimationStateMachineLibrary_SetState::Duration' has a wrong offset!");
//static_assert(offsetof(AnimationStateMachineLibrary_SetState, BlendType) == 0x000030, "Member 'AnimationStateMachineLibrary_SetState::BlendType' has a wrong offset!");
//static_assert(offsetof(AnimationStateMachineLibrary_SetState, BlendProfile) == 0x000038, "Member 'AnimationStateMachineLibrary_SetState::BlendProfile' has a wrong offset!");
//static_assert(offsetof(AnimationStateMachineLibrary_SetState, AlphaBlendOption) == 0x000040, "Member 'AnimationStateMachineLibrary_SetState::AlphaBlendOption' has a wrong offset!");
//static_assert(offsetof(AnimationStateMachineLibrary_SetState, CustomBlendCurve) == 0x000048, "Member 'AnimationStateMachineLibrary_SetState::CustomBlendCurve' has a wrong offset!");
...
//static_assert(sizeof(KismetAnimationLibrary_K2_CalculateVelocityFromSockets) == 0x000118, "Wrong size on KismetAnimationLibrary_K2_CalculateVelocityFromSockets");
...
//static_assert(offsetof(KismetAnimationLibrary_K2_CalculateVelocityFromSockets, OffsetInBoneSpace) == 0x000030, "Member 'KismetAnimationLibrary_K2_CalculateVelocityFromSockets::OffsetInBoneSpace' has a wrong offset!");
//static_assert(offsetof(KismetAnimationLibrary_K2_CalculateVelocityFromSockets, History) == 0x000048, "Member 'KismetAnimationLibrary_K2_CalculateVelocityFromSockets::History' has a wrong offset!");
//static_assert(offsetof(KismetAnimationLibrary_K2_CalculateVelocityFromSockets, NumberOfSamples) == 0x000078, "Member 'KismetAnimationLibrary_K2_CalculateVelocityFromSockets::NumberOfSamples' has a wrong offset!");
//static_assert(offsetof(KismetAnimationLibrary_K2_CalculateVelocityFromSockets, VelocityMin) == 0x00007C, "Member 'KismetAnimationLibrary_K2_CalculateVelocityFromSockets::VelocityMin' has a wrong offset!");
//static_assert(offsetof(KismetAnimationLibrary_K2_CalculateVelocityFromSockets, VelocityMax) == 0x000080, "Member 'KismetAnimationLibrary_K2_CalculateVelocityFromSockets::VelocityMax' has a wrong offset!");
//static_assert(offsetof(KismetAnimationLibrary_K2_CalculateVelocityFromSockets, EasingType) == 0x000084, "Member 'KismetAnimationLibrary_K2_CalculateVelocityFromSockets::EasingType' has a wrong offset!");
//static_assert(offsetof(KismetAnimationLibrary_K2_CalculateVelocityFromSockets, CustomCurve) == 0x000088, "Member 'KismetAnimationLibrary_K2_CalculateVelocityFromSockets::CustomCurve' has a wrong offset!");
//static_assert(offsetof(KismetAnimationLibrary_K2_CalculateVelocityFromSockets, ReturnValue) == 0x000110, "Member 'KismetAnimationLibrary_K2_CalculateVelocityFromSockets::ReturnValue' has a wrong offset!");
...
//static_assert(sizeof(KismetAnimationLibrary_K2_DirectionBetweenSockets) == 0x000038, "Wrong size on KismetAnimationLibrary_K2_DirectionBetweenSockets");
