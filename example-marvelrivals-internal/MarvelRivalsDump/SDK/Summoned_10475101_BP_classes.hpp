...
//static_assert(sizeof(ASummoned_10475101_BP_C) == 0x0008C0, "Wrong size on ASummoned_10475101_BP_C");
//static_assert(offsetof(ASummoned_10475101_BP_C, UberGraphFrame) == 0x0008B0, "Member 'ASummoned_10475101_BP_C::UberGraphFrame' has a wrong offset!");
//static_assert(offsetof(ASummoned_10475101_BP_C, SummonedMovement) == 0x0008B8, "Member 'ASummoned_10475101_BP_C::SummonedMovement' has a wrong offset!");
