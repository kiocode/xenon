...
static_assert(sizeof(UNNERuntimeORTDml) == 0x000050, "Wrong size on UNNERuntimeORTDml");
...
static_assert(sizeof(UNNERuntimeORTCpu) == 0x000050, "Wrong size on UNNERuntimeORTCpu");
