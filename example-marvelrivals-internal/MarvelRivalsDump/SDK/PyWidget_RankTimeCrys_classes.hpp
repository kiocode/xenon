...
static_assert(sizeof(UPyWidget_RankTimeCrys) == 0x000610, "Wrong size on UPyWidget_RankTimeCrys");
static_assert(offsetof(UPyWidget_RankTimeCrys, AkEvent_OnCrystalCharge) == 0x0005F0, "Member 'UPyWidget_RankTimeCrys::AkEvent_OnCrystalCharge' has a wrong offset!");
static_assert(offsetof(UPyWidget_RankTimeCrys, AkEvent_OnCrystalChargeFinished) == 0x0005F8, "Member 'UPyWidget_RankTimeCrys::AkEvent_OnCrystalChargeFinished' has a wrong offset!");
static_assert(offsetof(UPyWidget_RankTimeCrys, AkEvent_OnCrystalDisappear) == 0x000600, "Member 'UPyWidget_RankTimeCrys::AkEvent_OnCrystalDisappear' has a wrong offset!");
static_assert(offsetof(UPyWidget_RankTimeCrys, AkEvent_OnCrystalDisappearFinished) == 0x000608, "Member 'UPyWidget_RankTimeCrys::AkEvent_OnCrystalDisappearFinished' has a wrong offset!");
...
static_assert(sizeof(UPyWidget_RankTimeCrys_ProgressBar) == 0x0005F0, "Wrong size on UPyWidget_RankTimeCrys_ProgressBar");
