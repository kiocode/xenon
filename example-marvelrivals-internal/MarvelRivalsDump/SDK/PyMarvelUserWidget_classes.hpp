...
static_assert(sizeof(UPyMarvelUserWidget) == 0x0005F0, "Wrong size on UPyMarvelUserWidget");
static_assert(offsetof(UPyMarvelUserWidget, AkEvent_OnVisible) == 0x0005A8, "Member 'UPyMarvelUserWidget::AkEvent_OnVisible' has a wrong offset!");
static_assert(offsetof(UPyMarvelUserWidget, AkEvent_OnInvisible) == 0x0005B0, "Member 'UPyMarvelUserWidget::AkEvent_OnInvisible' has a wrong offset!");
static_assert(offsetof(UPyMarvelUserWidget, SwitchPanelState) == 0x0005B8, "Member 'UPyMarvelUserWidget::SwitchPanelState' has a wrong offset!");
static_assert(offsetof(UPyMarvelUserWidget, MusicItem_OnTop) == 0x0005C8, "Member 'UPyMarvelUserWidget::MusicItem_OnTop' has a wrong offset!");
static_assert(offsetof(UPyMarvelUserWidget, TransitionTime) == 0x0005D0, "Member 'UPyMarvelUserWidget::TransitionTime' has a wrong offset!");
static_assert(offsetof(UPyMarvelUserWidget, BlackTime) == 0x0005D4, "Member 'UPyMarvelUserWidget::BlackTime' has a wrong offset!");
static_assert(offsetof(UPyMarvelUserWidget, SystemUIName) == 0x0005D8, "Member 'UPyMarvelUserWidget::SystemUIName' has a wrong offset!");
static_assert(offsetof(UPyMarvelUserWidget, IsOverrideDefaultFocus) == 0x0005E8, "Member 'UPyMarvelUserWidget::IsOverrideDefaultFocus' has a wrong offset!");
