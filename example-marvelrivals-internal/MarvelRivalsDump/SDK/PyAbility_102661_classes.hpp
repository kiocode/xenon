...
static_assert(sizeof(APyCue_AbilityLoop_10266101) == 0x000E60, "Wrong size on APyCue_AbilityLoop_10266101");
static_assert(offsetof(APyCue_AbilityLoop_10266101, AbilityID) == 0x000E50, "Member 'APyCue_AbilityLoop_10266101::AbilityID' has a wrong offset!");
static_assert(offsetof(APyCue_AbilityLoop_10266101, TimerDuration1) == 0x000E54, "Member 'APyCue_AbilityLoop_10266101::TimerDuration1' has a wrong offset!");
static_assert(offsetof(APyCue_AbilityLoop_10266101, TimerDetachAfterDash) == 0x000E58, "Member 'APyCue_AbilityLoop_10266101::TimerDetachAfterDash' has a wrong offset!");
static_assert(offsetof(APyCue_AbilityLoop_10266101, TimerRemoveCue) == 0x000E5C, "Member 'APyCue_AbilityLoop_10266101::TimerRemoveCue' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnRefreshNumUpdate;                                // 0x25B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnNeedAddShield;                                   // 0x25C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpCDAudioStage;                                  // 0x25D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_102661) == 0x0025E8, "Wrong size on UPyAbility_102661");
static_assert(offsetof(UPyAbility_102661, OnRefreshNumUpdate) == 0x0025B8, "Member 'UPyAbility_102661::OnRefreshNumUpdate' has a wrong offset!");
static_assert(offsetof(UPyAbility_102661, OnNeedAddShield) == 0x0025C8, "Member 'UPyAbility_102661::OnNeedAddShield' has a wrong offset!");
static_assert(offsetof(UPyAbility_102661, OnUpCDAudioStage) == 0x0025D8, "Member 'UPyAbility_102661::OnUpCDAudioStage' has a wrong offset!");
...
static_assert(sizeof(UPyUIController_102661) == 0x000C80, "Wrong size on UPyUIController_102661");
static_assert(offsetof(UPyUIController_102661, Audio_CooldownEnd_Stage_One) == 0x000C60, "Member 'UPyUIController_102661::Audio_CooldownEnd_Stage_One' has a wrong offset!");
static_assert(offsetof(UPyUIController_102661, Audio_CooldownEnd_Stage_Two) == 0x000C68, "Member 'UPyUIController_102661::Audio_CooldownEnd_Stage_Two' has a wrong offset!");
static_assert(offsetof(UPyUIController_102661, Audio_CooldownEnd_Stage_Three) == 0x000C70, "Member 'UPyUIController_102661::Audio_CooldownEnd_Stage_Three' has a wrong offset!");
static_assert(offsetof(UPyUIController_102661, Audio_CooldownEnd_ResetStage_Interval_Time) == 0x000C78, "Member 'UPyUIController_102661::Audio_CooldownEnd_ResetStage_Interval_Time' has a wrong offset!");
...
static_assert(sizeof(UPyFallability_10266101) == 0x0012B8, "Wrong size on UPyFallability_10266101");
...
static_assert(sizeof(APyScope_10266101) == 0x001700, "Wrong size on APyScope_10266101");
