...
//static_assert(sizeof(UAbility_104231_BP_C) == 0x0025A8, "Wrong size on UAbility_104231_BP_C");
//static_assert(offsetof(UAbility_104231_BP_C, UberGraphFrame) == 0x0025A0, "Member 'UAbility_104231_BP_C::UberGraphFrame' has a wrong offset!");
