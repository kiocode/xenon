...
static_assert(sizeof(UPyUIController_103351) == 0x000C60, "Wrong size on UPyUIController_103351");
...
{
public:
	FMulticastInlineDelegateProperty_             OnAbilityCommit;                                   // 0x25E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAbilityCancel;                                   // 0x25F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_103351) == 0x002608, "Wrong size on UPyAbility_103351");
static_assert(offsetof(UPyAbility_103351, OnAbilityCommit) == 0x0025E8, "Member 'UPyAbility_103351::OnAbilityCommit' has a wrong offset!");
static_assert(offsetof(UPyAbility_103351, OnAbilityCancel) == 0x0025F8, "Member 'UPyAbility_103351::OnAbilityCancel' has a wrong offset!");
