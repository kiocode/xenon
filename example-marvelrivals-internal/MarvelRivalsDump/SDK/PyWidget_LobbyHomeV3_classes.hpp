...
static_assert(sizeof(UPyWidget_LobbyHomeV3) == 0x000628, "Wrong size on UPyWidget_LobbyHomeV3");
static_assert(offsetof(UPyWidget_LobbyHomeV3, AKEvent_LobbyStart) == 0x000618, "Member 'UPyWidget_LobbyHomeV3::AKEvent_LobbyStart' has a wrong offset!");
static_assert(offsetof(UPyWidget_LobbyHomeV3, EscAction) == 0x000620, "Member 'UPyWidget_LobbyHomeV3::EscAction' has a wrong offset!");
