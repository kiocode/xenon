...
static_assert(sizeof(UBuffAbility_10390102) == 0x001488, "Wrong size on UBuffAbility_10390102");
static_assert(offsetof(UBuffAbility_10390102, TargetToEnergyConversion) == 0x0010F8, "Member 'UBuffAbility_10390102::TargetToEnergyConversion' has a wrong offset!");
...
static_assert(sizeof(AProjectile_10392101) == 0x0030A0, "Wrong size on AProjectile_10392101");
static_assert(offsetof(AProjectile_10392101, SpeedCurve) == 0x003050, "Member 'AProjectile_10392101::SpeedCurve' has a wrong offset!");
static_assert(offsetof(AProjectile_10392101, HommingOffsetCurve) == 0x003058, "Member 'AProjectile_10392101::HommingOffsetCurve' has a wrong offset!");
static_assert(offsetof(AProjectile_10392101, HommingCurveMinDistance) == 0x003060, "Member 'AProjectile_10392101::HommingCurveMinDistance' has a wrong offset!");
...
static_assert(sizeof(ACue_Projectile_Loop_10392102) == 0x000DD0, "Wrong size on ACue_Projectile_Loop_10392102");
static_assert(offsetof(ACue_Projectile_Loop_10392102, WeaponNiagara) == 0x000DB0, "Member 'ACue_Projectile_Loop_10392102::WeaponNiagara' has a wrong offset!");
static_assert(offsetof(ACue_Projectile_Loop_10392102, RotationLerpDistance) == 0x000DB8, "Member 'ACue_Projectile_Loop_10392102::RotationLerpDistance' has a wrong offset!");
static_assert(offsetof(ACue_Projectile_Loop_10392102, RotationLerpAlpah) == 0x000DBC, "Member 'ACue_Projectile_Loop_10392102::RotationLerpAlpah' has a wrong offset!");
static_assert(offsetof(ACue_Projectile_Loop_10392102, HammerSocket) == 0x000DC0, "Member 'ACue_Projectile_Loop_10392102::HammerSocket' has a wrong offset!");
...
static_assert(sizeof(UAbility_103931) == 0x0025A0, "Wrong size on UAbility_103931");
static_assert(offsetof(UAbility_103931, ConfigRestoreEnergy) == 0x002588, "Member 'UAbility_103931::ConfigRestoreEnergy' has a wrong offset!");
static_assert(offsetof(UAbility_103931, Config) == 0x002598, "Member 'UAbility_103931::Config' has a wrong offset!");
...
static_assert(sizeof(AScope_10393101) == 0x001760, "Wrong size on AScope_10393101");
...
static_assert(sizeof(UAbility_103941) == 0x002580, "Wrong size on UAbility_103941");
...
static_assert(sizeof(UWidget_Extra_ThorCharge) == 0x0007B8, "Wrong size on UWidget_Extra_ThorCharge");
static_assert(offsetof(UWidget_Extra_ThorCharge, Widget_Energy) == 0x0007A8, "Member 'UWidget_Extra_ThorCharge::Widget_Energy' has a wrong offset!");
static_assert(offsetof(UWidget_Extra_ThorCharge, bIsCharging) == 0x0007B0, "Member 'UWidget_Extra_ThorCharge::bIsCharging' has a wrong offset!");
...
static_assert(sizeof(ACue_Ability_Loop_10395102) == 0x000E68, "Wrong size on ACue_Ability_Loop_10395102");
static_assert(offsetof(ACue_Ability_Loop_10395102, MoveStartAudioId) == 0x000E50, "Member 'ACue_Ability_Loop_10395102::MoveStartAudioId' has a wrong offset!");
static_assert(offsetof(ACue_Ability_Loop_10395102, MoveStopAudioId) == 0x000E54, "Member 'ACue_Ability_Loop_10395102::MoveStopAudioId' has a wrong offset!");
static_assert(offsetof(ACue_Ability_Loop_10395102, MyCharacter) == 0x000E60, "Member 'ACue_Ability_Loop_10395102::MyCharacter' has a wrong offset!");
...
static_assert(sizeof(UAbility_103961) == 0x002588, "Wrong size on UAbility_103961");
static_assert(offsetof(UAbility_103961, Config) == 0x002580, "Member 'UAbility_103961::Config' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             PreArrivedDelegate;                                // 0x1E68(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMarvelAbilityTask_PreArrivedDash) == 0x001E88, "Wrong size on UMarvelAbilityTask_PreArrivedDash");
static_assert(offsetof(UMarvelAbilityTask_PreArrivedDash, PreArrivedDelegate) == 0x001E68, "Member 'UMarvelAbilityTask_PreArrivedDash::PreArrivedDelegate' has a wrong offset!");
static_assert(offsetof(UMarvelAbilityTask_PreArrivedDash, PreArrivedInfo) == 0x001E78, "Member 'UMarvelAbilityTask_PreArrivedDash::PreArrivedInfo' has a wrong offset!");
static_assert(offsetof(UMarvelAbilityTask_PreArrivedDash, bHasPreArrived) == 0x001E80, "Member 'UMarvelAbilityTask_PreArrivedDash::bHasPreArrived' has a wrong offset!");
static_assert(offsetof(UMarvelAbilityTask_PreArrivedDash, ActivateTime) == 0x001E84, "Member 'UMarvelAbilityTask_PreArrivedDash::ActivateTime' has a wrong offset!");
...
static_assert(sizeof(ACue_Ability_Loop_10396101) == 0x000E78, "Wrong size on ACue_Ability_Loop_10396101");
static_assert(offsetof(ACue_Ability_Loop_10396101, ScopeTableID) == 0x000E50, "Member 'ACue_Ability_Loop_10396101::ScopeTableID' has a wrong offset!");
static_assert(offsetof(ACue_Ability_Loop_10396101, LineLength) == 0x000E54, "Member 'ACue_Ability_Loop_10396101::LineLength' has a wrong offset!");
static_assert(offsetof(ACue_Ability_Loop_10396101, TraceTypeQuery) == 0x000E58, "Member 'ACue_Ability_Loop_10396101::TraceTypeQuery' has a wrong offset!");
static_assert(offsetof(ACue_Ability_Loop_10396101, DecalComponent) == 0x000E60, "Member 'ACue_Ability_Loop_10396101::DecalComponent' has a wrong offset!");
static_assert(offsetof(ACue_Ability_Loop_10396101, MyCharacter) == 0x000E68, "Member 'ACue_Ability_Loop_10396101::MyCharacter' has a wrong offset!");
static_assert(offsetof(ACue_Ability_Loop_10396101, MyAbility) == 0x000E70, "Member 'ACue_Ability_Loop_10396101::MyAbility' has a wrong offset!");
...
static_assert(sizeof(UThorAnimInstance) == 0x000950, "Wrong size on UThorAnimInstance");
static_assert(offsetof(UThorAnimInstance, bUseAeroMotion) == 0x000910, "Member 'UThorAnimInstance::bUseAeroMotion' has a wrong offset!");
static_assert(offsetof(UThorAnimInstance, bUseStrikeFlyMotion) == 0x000911, "Member 'UThorAnimInstance::bUseStrikeFlyMotion' has a wrong offset!");
static_assert(offsetof(UThorAnimInstance, BaseMotionIndex) == 0x000914, "Member 'UThorAnimInstance::BaseMotionIndex' has a wrong offset!");
...
static_assert(sizeof(AThorCharacter) == 0x001820, "Wrong size on AThorCharacter");
static_assert(offsetof(AThorCharacter, ThorMoveLogic) == 0x001810, "Member 'AThorCharacter::ThorMoveLogic' has a wrong offset!");
...
static_assert(sizeof(UThorMovementComponent) == 0x001B60, "Wrong size on UThorMovementComponent");
