...
////static_assert(sizeof(UAbility_103221_BP_C) == 0x002598, "Wrong size on UAbility_103221_BP_C");
////static_assert(offsetof(UAbility_103221_BP_C, UberGraphFrame) == 0x002590, "Member 'UAbility_103221_BP_C::UberGraphFrame' has a wrong offset!");
