...
static_assert(sizeof(UPyAbility_102941) == 0x002598, "Wrong size on UPyAbility_102941");
static_assert(offsetof(UPyAbility_102941, DashingTag) == 0x002588, "Member 'UPyAbility_102941::DashingTag' has a wrong offset!");
