...
static_assert(sizeof(UPyAbility_101462) == 0x0025D0, "Wrong size on UPyAbility_101462");
static_assert(offsetof(UPyAbility_101462, IsTurretFiring) == 0x0025C8, "Member 'UPyAbility_101462::IsTurretFiring' has a wrong offset!");
