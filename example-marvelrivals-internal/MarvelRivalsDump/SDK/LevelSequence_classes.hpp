...
static_assert(sizeof(ALevelSequenceActor) == 0x000538, "Wrong size on ALevelSequenceActor");
static_assert(offsetof(ALevelSequenceActor, PlaybackSettings) == 0x0004A8, "Member 'ALevelSequenceActor::PlaybackSettings' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, SequencePlayer) == 0x0004C8, "Member 'ALevelSequenceActor::SequencePlayer' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, LevelSequenceAsset) == 0x0004D0, "Member 'ALevelSequenceActor::LevelSequenceAsset' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, CameraSettings) == 0x0004D8, "Member 'ALevelSequenceActor::CameraSettings' has a wrong offset!");
...
static_assert(offsetof(ALevelSequenceActor, BurnInInstance) == 0x000508, "Member 'ALevelSequenceActor::BurnInInstance' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, bShowBurnin) == 0x000510, "Member 'ALevelSequenceActor::bShowBurnin' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, WorldPartitionResolveData) == 0x000518, "Member 'ALevelSequenceActor::WorldPartitionResolveData' has a wrong offset!");
...
static_assert(sizeof(AReplicatedLevelSequenceActor) == 0x000538, "Wrong size on AReplicatedLevelSequenceActor");
...
{
public:
	FMulticastInlineDelegateProperty_             OnCameraCut;                                       // 0x04D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULevelSequencePlayer) == 0x000628, "Wrong size on ULevelSequencePlayer");
static_assert(offsetof(ULevelSequencePlayer, OnCameraCut) == 0x0004D8, "Member 'ULevelSequencePlayer::OnCameraCut' has a wrong offset!");
...
static_assert(sizeof(ALevelSequenceMediaController) == 0x0004B8, "Wrong size on ALevelSequenceMediaController");
static_assert(offsetof(ALevelSequenceMediaController, Sequence) == 0x000498, "Member 'ALevelSequenceMediaController::Sequence' has a wrong offset!");
static_assert(offsetof(ALevelSequenceMediaController, MediaComponent) == 0x0004A0, "Member 'ALevelSequenceMediaController::MediaComponent' has a wrong offset!");
static_assert(offsetof(ALevelSequenceMediaController, ServerStartTimeSeconds) == 0x0004A8, "Member 'ALevelSequenceMediaController::ServerStartTimeSeconds' has a wrong offset!");
