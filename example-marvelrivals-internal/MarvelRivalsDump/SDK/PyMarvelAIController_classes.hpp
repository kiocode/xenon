...
static_assert(sizeof(APyMarvelAIController) == 0x000A40, "Wrong size on APyMarvelAIController");
static_assert(offsetof(APyMarvelAIController, BTAsset) == 0x000A30, "Member 'APyMarvelAIController::BTAsset' has a wrong offset!");
static_assert(offsetof(APyMarvelAIController, AutoRunBT) == 0x000A38, "Member 'APyMarvelAIController::AutoRunBT' has a wrong offset!");
