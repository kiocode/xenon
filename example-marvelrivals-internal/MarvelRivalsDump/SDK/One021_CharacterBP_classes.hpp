...
static_assert(sizeof(AOne021_CharacterBP_C) == 0x001950, "Wrong size on AOne021_CharacterBP_C");
static_assert(offsetof(AOne021_CharacterBP_C, PhysicalInteraction) == 0x001940, "Member 'AOne021_CharacterBP_C::PhysicalInteraction' has a wrong offset!");
