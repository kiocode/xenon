...
public:
	...
	FMulticastInlineDelegateProperty_             OnVisibleChanged;                                  // 0x0458(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_LoadingPanelContainer) == 0x000468, "Wrong size on UPyWidget_LoadingPanelContainer");
...
static_assert(offsetof(UPyWidget_LoadingPanelContainer, WBP_Common_Panel_Watermark) == 0x000408, "Member 'UPyWidget_LoadingPanelContainer::WBP_Common_Panel_Watermark' has a wrong offset!");
static_assert(offsetof(UPyWidget_LoadingPanelContainer, WBP_Loading_Default) == 0x000410, "Member 'UPyWidget_LoadingPanelContainer::WBP_Loading_Default' has a wrong offset!");
static_assert(offsetof(UPyWidget_LoadingPanelContainer, Lazy_WBP_Loading_Game) == 0x000418, "Member 'UPyWidget_LoadingPanelContainer::Lazy_WBP_Loading_Game' has a wrong offset!");
static_assert(offsetof(UPyWidget_LoadingPanelContainer, Lazy_WBP_Loading_RankGame) == 0x000420, "Member 'UPyWidget_LoadingPanelContainer::Lazy_WBP_Loading_RankGame' has a wrong offset!");
static_assert(offsetof(UPyWidget_LoadingPanelContainer, Lazy_WBP_Replay_Loading) == 0x000428, "Member 'UPyWidget_LoadingPanelContainer::Lazy_WBP_Replay_Loading' has a wrong offset!");
static_assert(offsetof(UPyWidget_LoadingPanelContainer, Lazy_WBP_Loading_CareerHighLight) == 0x000430, "Member 'UPyWidget_LoadingPanelContainer::Lazy_WBP_Loading_CareerHighLight' has a wrong offset!");
static_assert(offsetof(UPyWidget_LoadingPanelContainer, Lazy_WBP_Common_Loading) == 0x000438, "Member 'UPyWidget_LoadingPanelContainer::Lazy_WBP_Common_Loading' has a wrong offset!");
static_assert(offsetof(UPyWidget_LoadingPanelContainer, Lazy_WBP_Loading_Lobby) == 0x000440, "Member 'UPyWidget_LoadingPanelContainer::Lazy_WBP_Loading_Lobby' has a wrong offset!");
static_assert(offsetof(UPyWidget_LoadingPanelContainer, Lazy_WBP_KillCam_Loading) == 0x000448, "Member 'UPyWidget_LoadingPanelContainer::Lazy_WBP_KillCam_Loading' has a wrong offset!");
static_assert(offsetof(UPyWidget_LoadingPanelContainer, Lazy_WBP_Loading_HeroLogo) == 0x000450, "Member 'UPyWidget_LoadingPanelContainer::Lazy_WBP_Loading_HeroLogo' has a wrong offset!");
static_assert(offsetof(UPyWidget_LoadingPanelContainer, OnVisibleChanged) == 0x000458, "Member 'UPyWidget_LoadingPanelContainer::OnVisibleChanged' has a wrong offset!");
