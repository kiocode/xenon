...
{
public:
	FMulticastInlineDelegateProperty_             OnProjectileBounce;                                // 0x3060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyProjectile_10251101) == 0x003070, "Wrong size on APyProjectile_10251101");
static_assert(offsetof(APyProjectile_10251101, OnProjectileBounce) == 0x003060, "Member 'APyProjectile_10251101::OnProjectileBounce' has a wrong offset!");
...
static_assert(sizeof(APyCue_Projectile_Loop_10251101) == 0x000DB8, "Wrong size on APyCue_Projectile_Loop_10251101");
static_assert(offsetof(APyCue_Projectile_Loop_10251101, TrajectoryAudioIDAfterBounce) == 0x000DB0, "Member 'APyCue_Projectile_Loop_10251101::TrajectoryAudioIDAfterBounce' has a wrong offset!");
