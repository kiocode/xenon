...
////static_assert(sizeof(UWBP_DropDown_Item_V4_C) == 0x000808, "Wrong size on UWBP_DropDown_Item_V4_C");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, UberGraphFrame) == 0x000790, "Member 'UWBP_DropDown_Item_V4_C::UberGraphFrame' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, Anim_Hovered) == 0x000798, "Member 'UWBP_DropDown_Item_V4_C::Anim_Hovered' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, HoriBox_Item) == 0x0007A0, "Member 'UWBP_DropDown_Item_V4_C::HoriBox_Item' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, Img_Check) == 0x0007A8, "Member 'UWBP_DropDown_Item_V4_C::Img_Check' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, Img_LeftColor) == 0x0007B0, "Member 'UWBP_DropDown_Item_V4_C::Img_LeftColor' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, Img_line) == 0x0007B8, "Member 'UWBP_DropDown_Item_V4_C::Img_line' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, Img_Mask_Disable) == 0x0007C0, "Member 'UWBP_DropDown_Item_V4_C::Img_Mask_Disable' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, Img_Privilege_Icon) == 0x0007C8, "Member 'UWBP_DropDown_Item_V4_C::Img_Privilege_Icon' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, Img_Tips) == 0x0007D0, "Member 'UWBP_DropDown_Item_V4_C::Img_Tips' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, Overlay_Content) == 0x0007D8, "Member 'UWBP_DropDown_Item_V4_C::Overlay_Content' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, Overlay_Main) == 0x0007E0, "Member 'UWBP_DropDown_Item_V4_C::Overlay_Main' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, Overlay_MainBtn) == 0x0007E8, "Member 'UWBP_DropDown_Item_V4_C::Overlay_MainBtn' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, ScaleBox_Privilege) == 0x0007F0, "Member 'UWBP_DropDown_Item_V4_C::ScaleBox_Privilege' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, SizeBox_Main) == 0x0007F8, "Member 'UWBP_DropDown_Item_V4_C::SizeBox_Main' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDown_Item_V4_C, WBP_DropDown_Icon) == 0x000800, "Member 'UWBP_DropDown_Item_V4_C::WBP_DropDown_Icon' has a wrong offset!");
