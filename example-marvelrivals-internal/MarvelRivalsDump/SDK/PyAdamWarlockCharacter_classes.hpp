...
static_assert(sizeof(APyAdamWarlockCharacter) == 0x001840, "Wrong size on APyAdamWarlockCharacter");
...
static_assert(sizeof(UPyWidget_AdamAbilityTips) == 0x0005A8, "Wrong size on UPyWidget_AdamAbilityTips");
