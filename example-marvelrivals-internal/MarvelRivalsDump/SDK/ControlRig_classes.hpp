...
public:
	...
	FMulticastInlineDelegateProperty_             OnPreInitializeDelegate;                           // 0x0840(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostInitializeDelegate;                          // 0x0850(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPreConstructionDelegate;                         // 0x0860(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostConstructionDelegate;                        // 0x0870(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPreForwardsSolveDelegate;                        // 0x0880(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostForwardsSolveDelegate;                       // 0x0890(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
//static_assert(sizeof(UControlRigComponent) == 0x0009A0, "Wrong size on UControlRigComponent");
//static_assert(offsetof(UControlRigComponent, ControlRigClass) == 0x000838, "Member 'UControlRigComponent::ControlRigClass' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, OnPreInitializeDelegate) == 0x000840, "Member 'UControlRigComponent::OnPreInitializeDelegate' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, OnPostInitializeDelegate) == 0x000850, "Member 'UControlRigComponent::OnPostInitializeDelegate' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, OnPreConstructionDelegate) == 0x000860, "Member 'UControlRigComponent::OnPreConstructionDelegate' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, OnPostConstructionDelegate) == 0x000870, "Member 'UControlRigComponent::OnPostConstructionDelegate' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, OnPreForwardsSolveDelegate) == 0x000880, "Member 'UControlRigComponent::OnPreForwardsSolveDelegate' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, OnPostForwardsSolveDelegate) == 0x000890, "Member 'UControlRigComponent::OnPostForwardsSolveDelegate' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, UserDefinedElements) == 0x0008A0, "Member 'UControlRigComponent::UserDefinedElements' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, MappedElements) == 0x0008B0, "Member 'UControlRigComponent::MappedElements' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, bEnableLazyEvaluation) == 0x0008C0, "Member 'UControlRigComponent::bEnableLazyEvaluation' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, LazyEvaluationPositionThreshold) == 0x0008C4, "Member 'UControlRigComponent::LazyEvaluationPositionThreshold' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, LazyEvaluationRotationThreshold) == 0x0008C8, "Member 'UControlRigComponent::LazyEvaluationRotationThreshold' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, LazyEvaluationScaleThreshold) == 0x0008CC, "Member 'UControlRigComponent::LazyEvaluationScaleThreshold' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, bResetTransformBeforeTick) == 0x0008D0, "Member 'UControlRigComponent::bResetTransformBeforeTick' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, bResetInitialsBeforeConstruction) == 0x0008D1, "Member 'UControlRigComponent::bResetInitialsBeforeConstruction' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, bUpdateRigOnTick) == 0x0008D2, "Member 'UControlRigComponent::bUpdateRigOnTick' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, bUpdateInEditor) == 0x0008D3, "Member 'UControlRigComponent::bUpdateInEditor' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, bDrawBones) == 0x0008D4, "Member 'UControlRigComponent::bDrawBones' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, bShowDebugDrawing) == 0x0008D5, "Member 'UControlRigComponent::bShowDebugDrawing' has a wrong offset!");
//static_assert(offsetof(UControlRigComponent, ControlRig) == 0x0008D8, "Member 'UControlRigComponent::ControlRig' has a wrong offset!");
...
//static_assert(sizeof(AControlRigControlActor) == 0x000550, "Wrong size on AControlRigControlActor");
//static_assert(offsetof(AControlRigControlActor, ActorToTrack) == 0x000490, "Member 'AControlRigControlActor::ActorToTrack' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, ControlRigClass) == 0x000498, "Member 'AControlRigControlActor::ControlRigClass' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, bRefreshOnTick) == 0x0004A0, "Member 'AControlRigControlActor::bRefreshOnTick' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, bIsSelectable) == 0x0004A1, "Member 'AControlRigControlActor::bIsSelectable' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, MaterialOverride) == 0x0004A8, "Member 'AControlRigControlActor::MaterialOverride' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, ColorParameter) == 0x0004B0, "Member 'AControlRigControlActor::ColorParameter' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, bCastShadows) == 0x0004C0, "Member 'AControlRigControlActor::bCastShadows' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, ActorRootComponent) == 0x0004C8, "Member 'AControlRigControlActor::ActorRootComponent' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, ControlRig) == 0x0004D0, "Member 'AControlRigControlActor::ControlRig' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, ControlNames) == 0x000500, "Member 'AControlRigControlActor::ControlNames' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, ShapeTransforms) == 0x000510, "Member 'AControlRigControlActor::ShapeTransforms' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, Components) == 0x000520, "Member 'AControlRigControlActor::Components' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, Materials) == 0x000530, "Member 'AControlRigControlActor::Materials' has a wrong offset!");
//static_assert(offsetof(AControlRigControlActor, ColorParameterName) == 0x000540, "Member 'AControlRigControlActor::ColorParameterName' has a wrong offset!");
...
//static_assert(sizeof(AControlRigShapeActor) == 0x0004E8, "Wrong size on AControlRigShapeActor");
//static_assert(offsetof(AControlRigShapeActor, ActorRootComponent) == 0x000490, "Member 'AControlRigShapeActor::ActorRootComponent' has a wrong offset!");
//static_assert(offsetof(AControlRigShapeActor, StaticMeshComponent) == 0x000498, "Member 'AControlRigShapeActor::StaticMeshComponent' has a wrong offset!");
//static_assert(offsetof(AControlRigShapeActor, ControlRigIndex) == 0x0004A0, "Member 'AControlRigShapeActor::ControlRigIndex' has a wrong offset!");
//static_assert(offsetof(AControlRigShapeActor, ControlRig) == 0x0004A4, "Member 'AControlRigShapeActor::ControlRig' has a wrong offset!");
//static_assert(offsetof(AControlRigShapeActor, ControlName) == 0x0004AC, "Member 'AControlRigShapeActor::ControlName' has a wrong offset!");
//static_assert(offsetof(AControlRigShapeActor, ShapeName) == 0x0004B8, "Member 'AControlRigShapeActor::ShapeName' has a wrong offset!");
//static_assert(offsetof(AControlRigShapeActor, ColorParameterName) == 0x0004C4, "Member 'AControlRigShapeActor::ColorParameterName' has a wrong offset!");
