...
//static_assert(sizeof(UWBP_Common_Slider_Color_C) == 0x000648, "Wrong size on UWBP_Common_Slider_Color_C");
//static_assert(offsetof(UWBP_Common_Slider_Color_C, Anim_Normal) == 0x000620, "Member 'UWBP_Common_Slider_Color_C::Anim_Normal' has a wrong offset!");
//static_assert(offsetof(UWBP_Common_Slider_Color_C, Anim_Press) == 0x000628, "Member 'UWBP_Common_Slider_Color_C::Anim_Press' has a wrong offset!");
//static_assert(offsetof(UWBP_Common_Slider_Color_C, Img_color) == 0x000630, "Member 'UWBP_Common_Slider_Color_C::Img_color' has a wrong offset!");
//static_assert(offsetof(UWBP_Common_Slider_Color_C, Slider_Quantity) == 0x000638, "Member 'UWBP_Common_Slider_Color_C::Slider_Quantity' has a wrong offset!");
//static_assert(offsetof(UWBP_Common_Slider_Color_C, Slider_Quantity_DefaultValue) == 0x000640, "Member 'UWBP_Common_Slider_Color_C::Slider_Quantity_DefaultValue' has a wrong offset!");
