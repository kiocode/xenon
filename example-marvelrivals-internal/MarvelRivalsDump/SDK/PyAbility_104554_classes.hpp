...
static_assert(sizeof(UPyAbility_104554) == 0x003530, "Wrong size on UPyAbility_104554");
static_assert(offsetof(UPyAbility_104554, LineTraceContext) == 0x0025A0, "Member 'UPyAbility_104554::LineTraceContext' has a wrong offset!");
