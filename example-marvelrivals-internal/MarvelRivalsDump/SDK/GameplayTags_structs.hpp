...
//static_assert(offsetof(FGameplayTagTableRow, Tag) == 0x000020, "Member 'FGameplayTagTableRow::Tag' has a wrong offset!");
...
//static_assert(sizeof(FRestrictedGameplayTagTableRow) == 0x000048, "Wrong size on FRestrictedGameplayTagTableRow");
//static_assert(offsetof(FRestrictedGameplayTagTableRow, bAllowNonRestrictedChildren) == 0x000040, "Member 'FRestrictedGameplayTagTableRow::bAllowNonRestrictedChildren' has a wrong offset!");
