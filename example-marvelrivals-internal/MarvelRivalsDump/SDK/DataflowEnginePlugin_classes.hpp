...
static_assert(sizeof(ADataflowActor) == 0x000498, "Wrong size on ADataflowActor");
static_assert(offsetof(ADataflowActor, DataflowComponent) == 0x000490, "Member 'ADataflowActor::DataflowComponent' has a wrong offset!");
...
static_assert(sizeof(UDataflowComponent) == 0x000980, "Wrong size on UDataflowComponent");
