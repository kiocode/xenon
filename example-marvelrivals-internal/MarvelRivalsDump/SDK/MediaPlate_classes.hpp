...
static_assert(sizeof(AMediaPlate) == 0x0004A0, "Wrong size on AMediaPlate");
static_assert(offsetof(AMediaPlate, MediaPlateComponent) == 0x000490, "Member 'AMediaPlate::MediaPlateComponent' has a wrong offset!");
static_assert(offsetof(AMediaPlate, StaticMeshComponent) == 0x000498, "Member 'AMediaPlate::StaticMeshComponent' has a wrong offset!");
