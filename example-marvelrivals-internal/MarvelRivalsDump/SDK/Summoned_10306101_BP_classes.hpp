...
//static_assert(sizeof(ASummoned_10306101_BP_C) == 0x000A90, "Wrong size on ASummoned_10306101_BP_C");
//static_assert(offsetof(ASummoned_10306101_BP_C, StaticMesh) == 0x000A80, "Member 'ASummoned_10306101_BP_C::StaticMesh' has a wrong offset!");
