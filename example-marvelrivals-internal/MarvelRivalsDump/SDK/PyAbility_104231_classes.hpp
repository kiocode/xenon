...
public:
	...
	FMulticastInlineDelegateProperty_             OnCurrentWebNumUpdate;                             // 0x2590(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_104231) == 0x0025A0, "Wrong size on UPyAbility_104231");
static_assert(offsetof(UPyAbility_104231, CurrentWebNum) == 0x002588, "Member 'UPyAbility_104231::CurrentWebNum' has a wrong offset!");
static_assert(offsetof(UPyAbility_104231, OnCurrentWebNumUpdate) == 0x002590, "Member 'UPyAbility_104231::OnCurrentWebNumUpdate' has a wrong offset!");
...
static_assert(sizeof(APyProjectile_10423101) == 0x003050, "Wrong size on APyProjectile_10423101");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnLinkStateChanged;                                // 0x0CB0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPySummonedComp_10423102) == 0x000CC0, "Wrong size on UPySummonedComp_10423102");
static_assert(offsetof(UPySummonedComp_10423102, GenMeshReformDispatcher) == 0x000CA0, "Member 'UPySummonedComp_10423102::GenMeshReformDispatcher' has a wrong offset!");
static_assert(offsetof(UPySummonedComp_10423102, OnLinkStateChanged) == 0x000CB0, "Member 'UPySummonedComp_10423102::OnLinkStateChanged' has a wrong offset!");
...
static_assert(sizeof(UPySummonedComp_10423101) == 0x000CA0, "Wrong size on UPySummonedComp_10423101");
...
static_assert(sizeof(UPyUIController_104231) == 0x000CC0, "Wrong size on UPyUIController_104231");
static_assert(offsetof(UPyUIController_104231, SideConfig) == 0x000C60, "Member 'UPyUIController_104231::SideConfig' has a wrong offset!");
static_assert(offsetof(UPyUIController_104231, MaxNum) == 0x000CB0, "Member 'UPyUIController_104231::MaxNum' has a wrong offset!");
static_assert(offsetof(UPyUIController_104231, NumClass) == 0x000CB8, "Member 'UPyUIController_104231::NumClass' has a wrong offset!");
