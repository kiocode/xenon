...
static_assert(sizeof(FFindBuildingPlace) == 0x000240, "Wrong size on FFindBuildingPlace");
static_assert(offsetof(FFindBuildingPlace, HitResult) == 0x000000, "Member 'FFindBuildingPlace::HitResult' has a wrong offset!");
static_assert(offsetof(FFindBuildingPlace, Transform) == 0x000170, "Member 'FFindBuildingPlace::Transform' has a wrong offset!");
static_assert(offsetof(FFindBuildingPlace, LocalLocation) == 0x0001D0, "Member 'FFindBuildingPlace::LocalLocation' has a wrong offset!");
static_assert(offsetof(FFindBuildingPlace, PortalSegments) == 0x0001E8, "Member 'FFindBuildingPlace::PortalSegments' has a wrong offset!");
static_assert(offsetof(FFindBuildingPlace, BuildingEdge) == 0x000238, "Member 'FFindBuildingPlace::BuildingEdge' has a wrong offset!");
