...
//static_assert(sizeof(UTypedElementSelectionSetLibrary) == 0x000030, "Wrong size on UTypedElementSelectionSetLibrary");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnPreSelectionChange;                              // 0x0830(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSelectionChange;                                 // 0x0840(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
//static_assert(offsetof(UTypedElementSelectionSet, OnPreSelectionChange) == 0x000830, "Member 'UTypedElementSelectionSet::OnPreSelectionChange' has a wrong offset!");
//static_assert(offsetof(UTypedElementSelectionSet, OnSelectionChange) == 0x000840, "Member 'UTypedElementSelectionSet::OnSelectionChange' has a wrong offset!");
...
//static_assert(sizeof(ITypedElementAssetDataInterface) == 0x000030, "Wrong size on ITypedElementAssetDataInterface");
...
//static_assert(sizeof(ITypedElementHierarchyInterface) == 0x000030, "Wrong size on ITypedElementHierarchyInterface");
...
//static_assert(sizeof(ITypedElementObjectInterface) == 0x000030, "Wrong size on ITypedElementObjectInterface");
...
//static_assert(sizeof(ITypedElementPrimitiveCustomDataInterface) == 0x000030, "Wrong size on ITypedElementPrimitiveCustomDataInterface");
...
//static_assert(sizeof(ITypedElementSelectionInterface) == 0x000030, "Wrong size on ITypedElementSelectionInterface");
