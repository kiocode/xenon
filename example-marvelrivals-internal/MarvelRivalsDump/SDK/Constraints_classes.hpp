...
//static_assert(sizeof(AConstraintsActor) == 0x000498, "Wrong size on AConstraintsActor");
//static_assert(offsetof(AConstraintsActor, ConstraintsManager) == 0x000490, "Member 'AConstraintsActor::ConstraintsManager' has a wrong offset!");
