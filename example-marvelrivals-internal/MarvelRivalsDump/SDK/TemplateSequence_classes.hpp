...
//static_assert(sizeof(ATemplateSequenceActor) == 0x0004F8, "Wrong size on ATemplateSequenceActor");
//static_assert(offsetof(ATemplateSequenceActor, PlaybackSettings) == 0x000498, "Member 'ATemplateSequenceActor::PlaybackSettings' has a wrong offset!");
//static_assert(offsetof(ATemplateSequenceActor, SequencePlayer) == 0x0004B8, "Member 'ATemplateSequenceActor::SequencePlayer' has a wrong offset!");
//static_assert(offsetof(ATemplateSequenceActor, TemplateSequence) == 0x0004C0, "Member 'ATemplateSequenceActor::TemplateSequence' has a wrong offset!");
//static_assert(offsetof(ATemplateSequenceActor, BindingOverride) == 0x0004E8, "Member 'ATemplateSequenceActor::BindingOverride' has a wrong offset!");
