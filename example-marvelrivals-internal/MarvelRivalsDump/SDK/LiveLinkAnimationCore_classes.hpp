...
static_assert(sizeof(ULiveLinkInstance) == 0x000430, "Wrong size on ULiveLinkInstance");
static_assert(offsetof(ULiveLinkInstance, CurrentRetargetAsset) == 0x000428, "Member 'ULiveLinkInstance::CurrentRetargetAsset' has a wrong offset!");
