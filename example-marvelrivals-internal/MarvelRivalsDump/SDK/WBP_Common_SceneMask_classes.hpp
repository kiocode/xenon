...
//static_assert(sizeof(UWBP_Common_SceneMask_C) == 0x0005B8, "Wrong size on UWBP_Common_SceneMask_C");
//static_assert(offsetof(UWBP_Common_SceneMask_C, MarvelImage_SceneMask) == 0x0005B0, "Member 'UWBP_Common_SceneMask_C::MarvelImage_SceneMask' has a wrong offset!");
