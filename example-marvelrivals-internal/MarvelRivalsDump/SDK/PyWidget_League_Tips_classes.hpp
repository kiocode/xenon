...
static_assert(sizeof(UPyWidget_League_Tips) == 0x0005F0, "Wrong size on UPyWidget_League_Tips");
static_assert(offsetof(UPyWidget_League_Tips, Show_Time) == 0x0005EC, "Member 'UPyWidget_League_Tips::Show_Time' has a wrong offset!");
