...
{
public:
	uint8                                         Pad_21B0[0x10];                                    // 0x21B0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
////static_assert(sizeof(UWebSocketConnection) == 0x0021C0, "Wrong size on UWebSocketConnection");
...
{
public:
	int32                                         WebSocketPort;                                     // 0x0A80(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
////static_assert(sizeof(UWebSocketNetDriver) == 0x000A90, "Wrong size on UWebSocketNetDriver");
////static_assert(offsetof(UWebSocketNetDriver, WebSocketPort) == 0x000A80, "Member 'UWebSocketNetDriver::WebSocketPort' has a wrong offset!");
