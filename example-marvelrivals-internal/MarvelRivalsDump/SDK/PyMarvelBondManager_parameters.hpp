...
static_assert(sizeof(PyMarvelBondManager_OnBondStateChange) == 0x0000A0, "Wrong size on PyMarvelBondManager_OnBondStateChange");
...
static_assert(offsetof(PyMarvelBondManager_OnBondStateChange, TriggerCharacters) == 0x000090, "Member 'PyMarvelBondManager_OnBondStateChange::TriggerCharacters' has a wrong offset!");
...
static_assert(sizeof(PyMarvelBondManager_OnAssistKillCallback) == 0x000758, "Wrong size on PyMarvelBondManager_OnAssistKillCallback");
...
static_assert(offsetof(PyMarvelBondManager_OnAssistKillCallback, InBondInstance) == 0x0006C8, "Member 'PyMarvelBondManager_OnAssistKillCallback::InBondInstance' has a wrong offset!");
...
static_assert(sizeof(PyMarvelBondManager_OnReceiverTriggeredCallback) == 0x0000A8, "Wrong size on PyMarvelBondManager_OnReceiverTriggeredCallback");
...
static_assert(sizeof(PyMarvelBondManager_OnSenderTriggeredCallback) == 0x0000A8, "Wrong size on PyMarvelBondManager_OnSenderTriggeredCallback");
