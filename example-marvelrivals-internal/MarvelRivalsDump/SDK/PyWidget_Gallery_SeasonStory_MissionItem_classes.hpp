...
static_assert(sizeof(UPyWidget_Gallery_SeasonStory_MissionItem) == 0x0005F0, "Wrong size on UPyWidget_Gallery_SeasonStory_MissionItem");
static_assert(offsetof(UPyWidget_Gallery_SeasonStory_MissionItem, MissionId) == 0x0005EC, "Member 'UPyWidget_Gallery_SeasonStory_MissionItem::MissionId' has a wrong offset!");
