...
//static_assert(sizeof(ConstraintsScriptingLibrary_CreateTransformableComponentHandle) == 0x000028, "Wrong size on ConstraintsScriptingLibrary_CreateTransformableComponentHandle");
...
//static_assert(offsetof(ConstraintsScriptingLibrary_CreateTransformableComponentHandle, ReturnValue) == 0x000020, "Member 'ConstraintsScriptingLibrary_CreateTransformableComponentHandle::ReturnValue' has a wrong offset!");
...
//static_assert(sizeof(ConstraintsScriptingLibrary_CreateTransformableHandle) == 0x000028, "Wrong size on ConstraintsScriptingLibrary_CreateTransformableHandle");
...
//static_assert(offsetof(ConstraintsScriptingLibrary_CreateTransformableHandle, ReturnValue) == 0x000020, "Member 'ConstraintsScriptingLibrary_CreateTransformableHandle::ReturnValue' has a wrong offset!");
