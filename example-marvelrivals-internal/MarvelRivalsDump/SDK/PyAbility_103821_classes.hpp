...
static_assert(sizeof(UPyAbility_103821) == 0x002588, "Wrong size on UPyAbility_103821");
...
static_assert(sizeof(UPyUIController_103821) == 0x000C78, "Wrong size on UPyUIController_103821");
static_assert(offsetof(UPyUIController_103821, UltraAbilityTag) == 0x000C60, "Member 'UPyUIController_103821::UltraAbilityTag' has a wrong offset!");
static_assert(offsetof(UPyUIController_103821, ShiftAbilityTag) == 0x000C6C, "Member 'UPyUIController_103821::ShiftAbilityTag' has a wrong offset!");
