...
static_assert(sizeof(UPyWidget_HomeEntrance_Advertisement_Container_Nav_Widget) == 0x0005F0, "Wrong size on UPyWidget_HomeEntrance_Advertisement_Container_Nav_Widget");
...
static_assert(sizeof(UPyWidget_HomeEntrance_Advertisement_Image_Widget) == 0x0005F8, "Wrong size on UPyWidget_HomeEntrance_Advertisement_Image_Widget");
static_assert(offsetof(UPyWidget_HomeEntrance_Advertisement_Image_Widget, Material_HoverHighLight) == 0x0005F0, "Member 'UPyWidget_HomeEntrance_Advertisement_Image_Widget::Material_HoverHighLight' has a wrong offset!");
...
static_assert(sizeof(UPyWidget_HomeEntrance_Advertisement_Container_Widget) == 0x000600, "Wrong size on UPyWidget_HomeEntrance_Advertisement_Container_Widget");
static_assert(offsetof(UPyWidget_HomeEntrance_Advertisement_Container_Widget, AdTexResList) == 0x0005F0, "Member 'UPyWidget_HomeEntrance_Advertisement_Container_Widget::AdTexResList' has a wrong offset!");
