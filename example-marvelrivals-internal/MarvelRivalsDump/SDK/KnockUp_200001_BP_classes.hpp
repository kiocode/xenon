...
static_assert(sizeof(UKnockUp_200001_BP_C) == 0x001DA0, "Wrong size on UKnockUp_200001_BP_C");
static_assert(offsetof(UKnockUp_200001_BP_C, UberGraphFrame) == 0x001D98, "Member 'UKnockUp_200001_BP_C::UberGraphFrame' has a wrong offset!");
