...
static_assert(sizeof(UPyWidget_Squad_StartButton) == 0x0008F0, "Wrong size on UPyWidget_Squad_StartButton");
static_assert(offsetof(UPyWidget_Squad_StartButton, TeamTips) == 0x0008E8, "Member 'UPyWidget_Squad_StartButton::TeamTips' has a wrong offset!");
