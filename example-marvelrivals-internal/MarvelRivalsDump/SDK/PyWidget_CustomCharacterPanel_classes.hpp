...
static_assert(offsetof(UPyWidget_CustomCharacterPanel, CharacterItemClass) == 0x000618, "Member 'UPyWidget_CustomCharacterPanel::CharacterItemClass' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterPanel, LineCount) == 0x000620, "Member 'UPyWidget_CustomCharacterPanel::LineCount' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterPanel, DelayShowTime) == 0x000624, "Member 'UPyWidget_CustomCharacterPanel::DelayShowTime' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterPanel, RowAnimInterval) == 0x000628, "Member 'UPyWidget_CustomCharacterPanel::RowAnimInterval' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterPanel, LineAnimInterval) == 0x00062C, "Member 'UPyWidget_CustomCharacterPanel::LineAnimInterval' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterPanel, GuideActions) == 0x000630, "Member 'UPyWidget_CustomCharacterPanel::GuideActions' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterPanel, EnableText) == 0x000640, "Member 'UPyWidget_CustomCharacterPanel::EnableText' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterPanel, DisableText) == 0x000658, "Member 'UPyWidget_CustomCharacterPanel::DisableText' has a wrong offset!");
...
static_assert(sizeof(UPyWidget_CustomCharacterItem) == 0x000970, "Wrong size on UPyWidget_CustomCharacterItem");
static_assert(offsetof(UPyWidget_CustomCharacterItem, Icon_Tank) == 0x0008E8, "Member 'UPyWidget_CustomCharacterItem::Icon_Tank' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterItem, Icon_damage) == 0x0008F0, "Member 'UPyWidget_CustomCharacterItem::Icon_damage' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterItem, Icon_support) == 0x0008F8, "Member 'UPyWidget_CustomCharacterItem::Icon_support' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterItem, Icon_Random) == 0x000900, "Member 'UPyWidget_CustomCharacterItem::Icon_Random' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterItem, Icon_All) == 0x000908, "Member 'UPyWidget_CustomCharacterItem::Icon_All' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterItem, NormalNameColor) == 0x000910, "Member 'UPyWidget_CustomCharacterItem::NormalNameColor' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterItem, SelectedNameColor) == 0x000924, "Member 'UPyWidget_CustomCharacterItem::SelectedNameColor' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterItem, NormalBgColor) == 0x000938, "Member 'UPyWidget_CustomCharacterItem::NormalBgColor' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterItem, SelectedBgColor) == 0x00094C, "Member 'UPyWidget_CustomCharacterItem::SelectedBgColor' has a wrong offset!");
static_assert(offsetof(UPyWidget_CustomCharacterItem, AkEvent_OnClicked) == 0x000960, "Member 'UPyWidget_CustomCharacterItem::AkEvent_OnClicked' has a wrong offset!");
