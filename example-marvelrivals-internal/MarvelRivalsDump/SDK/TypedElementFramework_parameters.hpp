...
//static_assert(offsetof(TypedElementListLibrary_CountElementsOfType, ReturnValue) == 0x00001C, "Member 'TypedElementListLibrary_CountElementsOfType::ReturnValue' has a wrong offset!");
...
//static_assert(offsetof(TypedElementListLibrary_HasElementsOfType, ReturnValue) == 0x00001C, "Member 'TypedElementListLibrary_HasElementsOfType::ReturnValue' has a wrong offset!");
