...
static_assert(sizeof(AComposurePipelineBaseActor) == 0x0004A8, "Wrong size on AComposurePipelineBaseActor");
static_assert(offsetof(AComposurePipelineBaseActor, bAutoRun) == 0x000490, "Member 'AComposurePipelineBaseActor::bAutoRun' has a wrong offset!");
static_assert(offsetof(AComposurePipelineBaseActor, bAutoRunChildElementsAndSelf) == 0x000491, "Member 'AComposurePipelineBaseActor::bAutoRunChildElementsAndSelf' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnTransformPassRendered_BP;                        // 0x0558(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFinalPassRendered_BP;                            // 0x0568(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ACompositingElement) == 0x000788, "Wrong size on ACompositingElement");
static_assert(offsetof(ACompositingElement, CompositingTarget) == 0x0004B0, "Member 'ACompositingElement::CompositingTarget' has a wrong offset!");
static_assert(offsetof(ACompositingElement, PostProcessProxy) == 0x0004B8, "Member 'ACompositingElement::PostProcessProxy' has a wrong offset!");
static_assert(offsetof(ACompositingElement, Inputs) == 0x0004C0, "Member 'ACompositingElement::Inputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, TransformPasses) == 0x0004D0, "Member 'ACompositingElement::TransformPasses' has a wrong offset!");
static_assert(offsetof(ACompositingElement, Outputs) == 0x0004E0, "Member 'ACompositingElement::Outputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, CameraSource) == 0x0004F0, "Member 'ACompositingElement::CameraSource' has a wrong offset!");
static_assert(offsetof(ACompositingElement, TargetCameraActor) == 0x0004F4, "Member 'ACompositingElement::TargetCameraActor' has a wrong offset!");
static_assert(offsetof(ACompositingElement, ResolutionSource) == 0x00050C, "Member 'ACompositingElement::ResolutionSource' has a wrong offset!");
static_assert(offsetof(ACompositingElement, RenderResolution) == 0x000510, "Member 'ACompositingElement::RenderResolution' has a wrong offset!");
static_assert(offsetof(ACompositingElement, RenderFormat) == 0x000518, "Member 'ACompositingElement::RenderFormat' has a wrong offset!");
static_assert(offsetof(ACompositingElement, bUseSharedTargetPool) == 0x000519, "Member 'ACompositingElement::bUseSharedTargetPool' has a wrong offset!");
static_assert(offsetof(ACompositingElement, FreezeFrameMask) == 0x000550, "Member 'ACompositingElement::FreezeFrameMask' has a wrong offset!");
static_assert(offsetof(ACompositingElement, OnTransformPassRendered_BP) == 0x000558, "Member 'ACompositingElement::OnTransformPassRendered_BP' has a wrong offset!");
static_assert(offsetof(ACompositingElement, OnFinalPassRendered_BP) == 0x000568, "Member 'ACompositingElement::OnFinalPassRendered_BP' has a wrong offset!");
static_assert(offsetof(ACompositingElement, CompShotIdName) == 0x000578, "Member 'ACompositingElement::CompShotIdName' has a wrong offset!");
static_assert(offsetof(ACompositingElement, Parent) == 0x000588, "Member 'ACompositingElement::Parent' has a wrong offset!");
static_assert(offsetof(ACompositingElement, ChildLayers) == 0x000590, "Member 'ACompositingElement::ChildLayers' has a wrong offset!");
static_assert(offsetof(ACompositingElement, OutputOpacity) == 0x0005A4, "Member 'ACompositingElement::OutputOpacity' has a wrong offset!");
static_assert(offsetof(ACompositingElement, UserConstructedInputs) == 0x0005A8, "Member 'ACompositingElement::UserConstructedInputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, UserConstructedTransforms) == 0x0005F8, "Member 'ACompositingElement::UserConstructedTransforms' has a wrong offset!");
static_assert(offsetof(ACompositingElement, UserConstructedOutputs) == 0x000648, "Member 'ACompositingElement::UserConstructedOutputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, InternalInputs) == 0x000698, "Member 'ACompositingElement::InternalInputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, InternalTransformPasses) == 0x0006A8, "Member 'ACompositingElement::InternalTransformPasses' has a wrong offset!");
static_assert(offsetof(ACompositingElement, InternalOutputs) == 0x0006B8, "Member 'ACompositingElement::InternalOutputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, InternalAlphaPass) == 0x0006C8, "Member 'ACompositingElement::InternalAlphaPass' has a wrong offset!");
...
static_assert(sizeof(ACompositingCaptureBase) == 0x0007D8, "Wrong size on ACompositingCaptureBase");
static_assert(offsetof(ACompositingCaptureBase, SceneCaptureComponent2D) == 0x000788, "Member 'ACompositingCaptureBase::SceneCaptureComponent2D' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, bApplyDistortion) == 0x000790, "Member 'ACompositingCaptureBase::bApplyDistortion' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, LensComponentPicker) == 0x000798, "Member 'ACompositingCaptureBase::LensComponentPicker' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, OverscanFactor) == 0x0007C8, "Member 'ACompositingCaptureBase::OverscanFactor' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, OriginalFocalLength) == 0x0007CC, "Member 'ACompositingCaptureBase::OriginalFocalLength' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, LastDistortionMID) == 0x0007D0, "Member 'ACompositingCaptureBase::LastDistortionMID' has a wrong offset!");
