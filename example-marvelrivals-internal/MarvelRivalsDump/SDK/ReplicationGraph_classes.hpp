...
//static_assert(sizeof(AReplicationGraphDebugActor) == 0x0004A0, "Wrong size on AReplicationGraphDebugActor");
//static_assert(offsetof(AReplicationGraphDebugActor, ReplicationGraph) == 0x000490, "Member 'AReplicationGraphDebugActor::ReplicationGraph' has a wrong offset!");
//static_assert(offsetof(AReplicationGraphDebugActor, ConnectionManager) == 0x000498, "Member 'AReplicationGraphDebugActor::ConnectionManager' has a wrong offset!");
