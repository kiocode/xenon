...
//static_assert(offsetof(USynthSound, OwningSynthComponent) == 0x000490, "Member 'USynthSound::OwningSynthComponent' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnAudioEnvelopeValue;                              // 0x0A68(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
//static_assert(sizeof(USynthComponent) == 0x000AD0, "Wrong size on USynthComponent");
//static_assert(offsetof(USynthComponent, AttenuationSettings) == 0x000478, "Member 'USynthComponent::AttenuationSettings' has a wrong offset!");
//static_assert(offsetof(USynthComponent, AttenuationOverrides) == 0x000480, "Member 'USynthComponent::AttenuationOverrides' has a wrong offset!");
//static_assert(offsetof(USynthComponent, ConcurrencySettings) == 0x000850, "Member 'USynthComponent::ConcurrencySettings' has a wrong offset!");
//static_assert(offsetof(USynthComponent, ConcurrencySet) == 0x000858, "Member 'USynthComponent::ConcurrencySet' has a wrong offset!");
//static_assert(offsetof(USynthComponent, ModulationRouting) == 0x0008A8, "Member 'USynthComponent::ModulationRouting' has a wrong offset!");
//static_assert(offsetof(USynthComponent, SoundClass) == 0x000A10, "Member 'USynthComponent::SoundClass' has a wrong offset!");
//static_assert(offsetof(USynthComponent, SourceEffectChain) == 0x000A18, "Member 'USynthComponent::SourceEffectChain' has a wrong offset!");
//static_assert(offsetof(USynthComponent, SoundSubmix) == 0x000A20, "Member 'USynthComponent::SoundSubmix' has a wrong offset!");
//static_assert(offsetof(USynthComponent, SoundSubmixSends) == 0x000A28, "Member 'USynthComponent::SoundSubmixSends' has a wrong offset!");
//static_assert(offsetof(USynthComponent, BusSends) == 0x000A38, "Member 'USynthComponent::BusSends' has a wrong offset!");
//static_assert(offsetof(USynthComponent, PreEffectBusSends) == 0x000A48, "Member 'USynthComponent::PreEffectBusSends' has a wrong offset!");
//static_assert(offsetof(USynthComponent, EnvelopeFollowerAttackTime) == 0x000A5C, "Member 'USynthComponent::EnvelopeFollowerAttackTime' has a wrong offset!");
//static_assert(offsetof(USynthComponent, EnvelopeFollowerReleaseTime) == 0x000A60, "Member 'USynthComponent::EnvelopeFollowerReleaseTime' has a wrong offset!");
//static_assert(offsetof(USynthComponent, OnAudioEnvelopeValue) == 0x000A68, "Member 'USynthComponent::OnAudioEnvelopeValue' has a wrong offset!");
//static_assert(offsetof(USynthComponent, Synth) == 0x000A98, "Member 'USynthComponent::Synth' has a wrong offset!");
//static_assert(offsetof(USynthComponent, AudioComponent) == 0x000AA0, "Member 'USynthComponent::AudioComponent' has a wrong offset!");
