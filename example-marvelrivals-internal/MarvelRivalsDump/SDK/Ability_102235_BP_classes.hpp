...
////static_assert(sizeof(UAbility_102235_BP_C) == 0x002588, "Wrong size on UAbility_102235_BP_C");
////static_assert(offsetof(UAbility_102235_BP_C, UberGraphFrame) == 0x002580, "Member 'UAbility_102235_BP_C::UberGraphFrame' has a wrong offset!");
