...
static_assert(sizeof(APhysicsControlActor) == 0x0004A0, "Wrong size on APhysicsControlActor");
static_assert(offsetof(APhysicsControlActor, ControlComponent) == 0x000490, "Member 'APhysicsControlActor::ControlComponent' has a wrong offset!");
static_assert(offsetof(APhysicsControlActor, ControlInitializerComponent) == 0x000498, "Member 'APhysicsControlActor::ControlInitializerComponent' has a wrong offset!");
