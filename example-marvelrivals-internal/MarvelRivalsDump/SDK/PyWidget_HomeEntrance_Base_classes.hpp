...
static_assert(sizeof(UPyWidget_HomeEntrance_Item_Container_Widget_Base) == 0x0005F0, "Wrong size on UPyWidget_HomeEntrance_Item_Container_Widget_Base");

// PythonClass PyWidget_HomeEntrance_Base.PyWidget_HomeEntrance_Item_Container_Nav_Widget_Base
// 0x0000 (0x05F0 - 0x05F0)
class UPyWidget_HomeEntrance_Item_Container_Nav_Widget_Base : public UPyMarvelUserWidget
{
public:
	void Construct();
...
static_assert(sizeof(UPyWidget_HomeEntrance_Item_Container_Nav_Widget_Base) == 0x0005F0, "Wrong size on UPyWidget_HomeEntrance_Item_Container_Nav_Widget_Base");
