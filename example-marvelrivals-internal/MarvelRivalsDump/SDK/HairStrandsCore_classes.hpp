...
static_assert(sizeof(AGroomActor) == 0x000498, "Wrong size on AGroomActor");
static_assert(offsetof(AGroomActor, GroomComponent) == 0x000490, "Member 'AGroomActor::GroomComponent' has a wrong offset!");
...
static_assert(sizeof(UGroomComponent) == 0x000B00, "Wrong size on UGroomComponent");
static_assert(offsetof(UGroomComponent, GroomAsset) == 0x0008B8, "Member 'UGroomComponent::GroomAsset' has a wrong offset!");
static_assert(offsetof(UGroomComponent, GroomCache) == 0x0008C0, "Member 'UGroomComponent::GroomCache' has a wrong offset!");
static_assert(offsetof(UGroomComponent, NiagaraComponents) == 0x0008C8, "Member 'UGroomComponent::NiagaraComponents' has a wrong offset!");
static_assert(offsetof(UGroomComponent, SourceSkeletalMesh) == 0x0008D8, "Member 'UGroomComponent::SourceSkeletalMesh' has a wrong offset!");
static_assert(offsetof(UGroomComponent, BindingAsset) == 0x0008E0, "Member 'UGroomComponent::BindingAsset' has a wrong offset!");
static_assert(offsetof(UGroomComponent, PhysicsAsset) == 0x0008E8, "Member 'UGroomComponent::PhysicsAsset' has a wrong offset!");
static_assert(offsetof(UGroomComponent, SimulationSettings) == 0x000900, "Member 'UGroomComponent::SimulationSettings' has a wrong offset!");
static_assert(offsetof(UGroomComponent, MeshDeformer) == 0x000990, "Member 'UGroomComponent::MeshDeformer' has a wrong offset!");
static_assert(offsetof(UGroomComponent, MeshDeformerInstance) == 0x000998, "Member 'UGroomComponent::MeshDeformerInstance' has a wrong offset!");
static_assert(offsetof(UGroomComponent, MeshDeformerInstanceSettings) == 0x0009A0, "Member 'UGroomComponent::MeshDeformerInstanceSettings' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Strands_DebugMaterial) == 0x0009A8, "Member 'UGroomComponent::Strands_DebugMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Strands_DefaultMaterial) == 0x0009B0, "Member 'UGroomComponent::Strands_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Cards_DefaultMaterial) == 0x0009B8, "Member 'UGroomComponent::Cards_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Meshes_DefaultMaterial) == 0x0009C0, "Member 'UGroomComponent::Meshes_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, AngularSpringsSystem) == 0x0009C8, "Member 'UGroomComponent::AngularSpringsSystem' has a wrong offset!");
static_assert(offsetof(UGroomComponent, CosseratRodsSystem) == 0x0009D0, "Member 'UGroomComponent::CosseratRodsSystem' has a wrong offset!");
static_assert(offsetof(UGroomComponent, AttachmentName) == 0x0009D8, "Member 'UGroomComponent::AttachmentName' has a wrong offset!");
static_assert(offsetof(UGroomComponent, GroomGroupsDesc) == 0x000A70, "Member 'UGroomComponent::GroomGroupsDesc' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bUseCards) == 0x000A80, "Member 'UGroomComponent::bUseCards' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bRunning) == 0x000A81, "Member 'UGroomComponent::bRunning' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bLooping) == 0x000A82, "Member 'UGroomComponent::bLooping' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bManualTick) == 0x000A83, "Member 'UGroomComponent::bManualTick' has a wrong offset!");
static_assert(offsetof(UGroomComponent, ElapsedTime) == 0x000A84, "Member 'UGroomComponent::ElapsedTime' has a wrong offset!");
