...
////static_assert(sizeof(UWC_AudioEmitterBP_C) == 0x000A30, "Wrong size on UWC_AudioEmitterBP_C");
////static_assert(offsetof(UWC_AudioEmitterBP_C, UberGraphFrame) == 0x000A20, "Member 'UWC_AudioEmitterBP_C::UberGraphFrame' has a wrong offset!");
