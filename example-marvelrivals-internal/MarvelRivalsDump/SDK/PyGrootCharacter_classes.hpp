...
static_assert(sizeof(APyGrootCharacter) == 0x001840, "Wrong size on APyGrootCharacter");
static_assert(offsetof(APyGrootCharacter, IsBeAttached) == 0x001830, "Member 'APyGrootCharacter::IsBeAttached' has a wrong offset!");
