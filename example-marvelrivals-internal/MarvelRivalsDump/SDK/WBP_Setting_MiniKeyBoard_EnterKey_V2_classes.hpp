...
////static_assert(sizeof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C) == 0x000778, "Wrong size on UWBP_Setting_MiniKeyBoard_EnterKey_V2_C");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, UberGraphFrame) == 0x0005F0, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::UberGraphFrame' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Bg_Key) == 0x0005F8, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Bg_Key' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Bg_Key_Frame) == 0x000600, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Bg_Key_Frame' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Btn_Key) == 0x000608, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Btn_Key' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Icon_Key) == 0x000610, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Icon_Key' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Overlay_Key) == 0x000618, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Overlay_Key' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, SizeBox_Key) == 0x000620, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::SizeBox_Key' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Text_KeyName) == 0x000628, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Text_KeyName' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, SetIcon) == 0x000630, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::SetIcon' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Name_0) == 0x000638, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Name_0' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, SpecialName) == 0x000650, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::SpecialName' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Font) == 0x000660, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Font' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Width) == 0x0006C8, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Width' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Height) == 0x0006D0, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Height' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Normal) == 0x0006D8, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Normal' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Combine) == 0x0006E0, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Combine' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, IsCombine) == 0x0006E8, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::IsCombine' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Text_Color_Combine) == 0x0006EC, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Text_Color_Combine' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Text_Color_Normal) == 0x000700, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Text_Color_Normal' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, IsDisable) == 0x000714, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::IsDisable' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, IsConflict) == 0x000715, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::IsConflict' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Conflict) == 0x000718, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Conflict' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, NormalColor) == 0x000720, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::NormalColor' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, CombineColor) == 0x000730, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::CombineColor' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, Image_0) == 0x000740, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::Image_0' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, ConflictColor) == 0x000748, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::ConflictColor' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, CommonFrameColor) == 0x000758, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::CommonFrameColor' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_MiniKeyBoard_EnterKey_V2_C, DisableFrameColor) == 0x000768, "Member 'UWBP_Setting_MiniKeyBoard_EnterKey_V2_C::DisableFrameColor' has a wrong offset!");
