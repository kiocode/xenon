...
class UPyWidget_HeroList_Card final : public UPyWidget_HeroList_CardBase
{
public:
	void OnInitialized();
...
static_assert(sizeof(UPyWidget_HeroList_Card) == 0x0007A8, "Wrong size on UPyWidget_HeroList_Card");
