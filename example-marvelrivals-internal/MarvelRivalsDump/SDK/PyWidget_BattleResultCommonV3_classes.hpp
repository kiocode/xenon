...
static_assert(sizeof(UPyWidget_HeroUsedV3) == 0x0005F0, "Wrong size on UPyWidget_HeroUsedV3");
...
static_assert(sizeof(UPyWidget_BattleResultMedalTipsUnit) == 0x0005F0, "Wrong size on UPyWidget_BattleResultMedalTipsUnit");
