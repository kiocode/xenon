...
public:
	...
	FMulticastInlineDelegateProperty_             OnClaimedResourcesChange;                          // 0x0148(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGameplayTasksComponent, SimulatedTasks) == 0x000158, "Member 'UGameplayTasksComponent::SimulatedTasks' has a wrong offset!");
...
static_assert(sizeof(UGameplayTask_SpawnActor) == 0x0000D0, "Wrong size on UGameplayTask_SpawnActor");
...
static_assert(offsetof(UGameplayTask_SpawnActor, ClassToSpawn) == 0x0000C8, "Member 'UGameplayTask_SpawnActor::ClassToSpawn' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnFinished;                                        // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTimeExpired;                                     // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
