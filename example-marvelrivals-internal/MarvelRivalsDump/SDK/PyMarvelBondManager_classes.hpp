...
static_assert(sizeof(APyMarvelBondManager) == 0x000628, "Wrong size on APyMarvelBondManager");
...
static_assert(sizeof(UPyMarvelDefaultBondAbility) == 0x002580, "Wrong size on UPyMarvelDefaultBondAbility");
