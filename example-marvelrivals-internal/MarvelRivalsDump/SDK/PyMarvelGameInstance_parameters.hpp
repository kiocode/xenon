...
{
public:
	int32                                         State;                                             // 0x0000(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(PyMarvelGameInstance_OnUEConnectionTimeOut) == 0x000018, "Wrong size on PyMarvelGameInstance_OnUEConnectionTimeOut");
static_assert(offsetof(PyMarvelGameInstance_OnUEConnectionTimeOut, State) == 0x000000, "Member 'PyMarvelGameInstance_OnUEConnectionTimeOut::State' has a wrong offset!");
static_assert(offsetof(PyMarvelGameInstance_OnUEConnectionTimeOut, Msg) == 0x000008, "Member 'PyMarvelGameInstance_OnUEConnectionTimeOut::Msg' has a wrong offset!");
