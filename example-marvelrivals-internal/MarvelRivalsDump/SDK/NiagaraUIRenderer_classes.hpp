...
static_assert(sizeof(ANiagaraUIActor) == 0x000490, "Wrong size on ANiagaraUIActor");
...
static_assert(sizeof(UNiagaraUIComponent) == 0x000B80, "Wrong size on UNiagaraUIComponent");
