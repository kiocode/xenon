...
static_assert(sizeof(UPyWidget_League_DetailsView) == 0x000618, "Wrong size on UPyWidget_League_DetailsView");
...
static_assert(sizeof(UPyWidget_League_StagePageNode) == 0x0005F0, "Wrong size on UPyWidget_League_StagePageNode");
