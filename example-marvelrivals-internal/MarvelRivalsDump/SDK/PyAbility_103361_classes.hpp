...
static_assert(sizeof(UPyAbility_103361) == 0x002588, "Wrong size on UPyAbility_103361");
static_assert(offsetof(UPyAbility_103361, IsAmmoReady) == 0x002580, "Member 'UPyAbility_103361::IsAmmoReady' has a wrong offset!");
static_assert(offsetof(UPyAbility_103361, OpenDetectionState) == 0x002581, "Member 'UPyAbility_103361::OpenDetectionState' has a wrong offset!");
