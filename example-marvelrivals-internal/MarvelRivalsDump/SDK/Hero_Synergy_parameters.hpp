...
static_assert(sizeof(MarvelBackTrackAbility_SafeMoveTo) == 0x000190, "Wrong size on MarvelBackTrackAbility_SafeMoveTo");
...
static_assert(offsetof(MarvelBackTrackAbility_SafeMoveTo, bSweep) == 0x000188, "Member 'MarvelBackTrackAbility_SafeMoveTo::bSweep' has a wrong offset!");
static_assert(offsetof(MarvelBackTrackAbility_SafeMoveTo, ReturnValue) == 0x000189, "Member 'MarvelBackTrackAbility_SafeMoveTo::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(TraceComponent_100009_OnPreOutTraceResults) == 0x000178, "Wrong size on TraceComponent_100009_OnPreOutTraceResults");
...
static_assert(offsetof(TraceComponent_100009_OnPreOutTraceResults, ReturnValue) == 0x000170, "Member 'TraceComponent_100009_OnPreOutTraceResults::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BuffManagerAbility_100009_OnOwnerCollide) == 0x0001A0, "Wrong size on BuffManagerAbility_100009_OnOwnerCollide");
...
static_assert(sizeof(Ability_100015_AddWavingData) == 0x000170, "Wrong size on Ability_100015_AddWavingData");
