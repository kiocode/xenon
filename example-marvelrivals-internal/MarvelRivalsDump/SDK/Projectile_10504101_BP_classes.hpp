...
static_assert(sizeof(AProjectile_10504101_BP_C) == 0x003070, "Wrong size on AProjectile_10504101_BP_C");
static_assert(offsetof(AProjectile_10504101_BP_C, UberGraphFrame) == 0x003050, "Member 'AProjectile_10504101_BP_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AProjectile_10504101_BP_C, Impact_Normal) == 0x003058, "Member 'AProjectile_10504101_BP_C::Impact_Normal' has a wrong offset!");
