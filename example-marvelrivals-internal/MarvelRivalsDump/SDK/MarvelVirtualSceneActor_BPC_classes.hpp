...
static_assert(sizeof(AMarvelVirtualSceneActor_BPC_C) == 0x0014B0, "Wrong size on AMarvelVirtualSceneActor_BPC_C");
static_assert(offsetof(AMarvelVirtualSceneActor_BPC_C, DefaultSceneRoot) == 0x0014A0, "Member 'AMarvelVirtualSceneActor_BPC_C::DefaultSceneRoot' has a wrong offset!");
