...
static_assert(sizeof(UPyWidget_BattlePass_RewardItem) == 0x0008F0, "Wrong size on UPyWidget_BattlePass_RewardItem");
...
static_assert(sizeof(UPyWidget_BattlePass_Unlock) == 0x000658, "Wrong size on UPyWidget_BattlePass_Unlock");
static_assert(offsetof(UPyWidget_BattlePass_Unlock, Normal_Reward) == 0x000618, "Member 'UPyWidget_BattlePass_Unlock::Normal_Reward' has a wrong offset!");
static_assert(offsetof(UPyWidget_BattlePass_Unlock, Advance_Reward) == 0x000628, "Member 'UPyWidget_BattlePass_Unlock::Advance_Reward' has a wrong offset!");
static_assert(offsetof(UPyWidget_BattlePass_Unlock, Free_To_Advance_Reward) == 0x000638, "Member 'UPyWidget_BattlePass_Unlock::Free_To_Advance_Reward' has a wrong offset!");
static_assert(offsetof(UPyWidget_BattlePass_Unlock, Reward_Delay_Time) == 0x000648, "Member 'UPyWidget_BattlePass_Unlock::Reward_Delay_Time' has a wrong offset!");
static_assert(offsetof(UPyWidget_BattlePass_Unlock, Normal_To_Advance_Text_Delay_Time) == 0x00064C, "Member 'UPyWidget_BattlePass_Unlock::Normal_To_Advance_Text_Delay_Time' has a wrong offset!");
static_assert(offsetof(UPyWidget_BattlePass_Unlock, AkEvent_Upgrade) == 0x000650, "Member 'UPyWidget_BattlePass_Unlock::AkEvent_Upgrade' has a wrong offset!");
