...
public:
	...
	FMulticastInlineDelegateProperty_             OnItemSelected;                                    // 0x0600(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnItemHovered;                                     // 0x0610(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_HeroSystem_ItemList) == 0x000620, "Wrong size on UPyWidget_HeroSystem_ItemList");
static_assert(offsetof(UPyWidget_HeroSystem_ItemList, HeroSystem_ItemUnit) == 0x0005F0, "Member 'UPyWidget_HeroSystem_ItemList::HeroSystem_ItemUnit' has a wrong offset!");
static_assert(offsetof(UPyWidget_HeroSystem_ItemList, FixColumnCount) == 0x0005F8, "Member 'UPyWidget_HeroSystem_ItemList::FixColumnCount' has a wrong offset!");
static_assert(offsetof(UPyWidget_HeroSystem_ItemList, ItemCount) == 0x0005FC, "Member 'UPyWidget_HeroSystem_ItemList::ItemCount' has a wrong offset!");
static_assert(offsetof(UPyWidget_HeroSystem_ItemList, OnItemSelected) == 0x000600, "Member 'UPyWidget_HeroSystem_ItemList::OnItemSelected' has a wrong offset!");
static_assert(offsetof(UPyWidget_HeroSystem_ItemList, OnItemHovered) == 0x000610, "Member 'UPyWidget_HeroSystem_ItemList::OnItemHovered' has a wrong offset!");
