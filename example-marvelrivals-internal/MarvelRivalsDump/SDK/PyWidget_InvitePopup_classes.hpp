...
static_assert(sizeof(UPyWidget_InvitePopupBase) == 0x000620, "Wrong size on UPyWidget_InvitePopupBase");
static_assert(offsetof(UPyWidget_InvitePopupBase, AKEvent_ClickYes) == 0x0005F0, "Member 'UPyWidget_InvitePopupBase::AKEvent_ClickYes' has a wrong offset!");
static_assert(offsetof(UPyWidget_InvitePopupBase, AKEvent_ClickNo) == 0x0005F8, "Member 'UPyWidget_InvitePopupBase::AKEvent_ClickNo' has a wrong offset!");
static_assert(offsetof(UPyWidget_InvitePopupBase, InviteColor) == 0x000600, "Member 'UPyWidget_InvitePopupBase::InviteColor' has a wrong offset!");
static_assert(offsetof(UPyWidget_InvitePopupBase, ApplyColor) == 0x000610, "Member 'UPyWidget_InvitePopupBase::ApplyColor' has a wrong offset!");
...
static_assert(sizeof(UPyWidget_InvitePopup) == 0x000620, "Wrong size on UPyWidget_InvitePopup");
...
static_assert(sizeof(UPyWidget_InvitePopup_League) == 0x000620, "Wrong size on UPyWidget_InvitePopup_League");
