...
static_assert(sizeof(APyLokiCharacter) == 0x001850, "Wrong size on APyLokiCharacter");
static_assert(offsetof(APyLokiCharacter, PhantomAbilityID) == 0x001840, "Member 'APyLokiCharacter::PhantomAbilityID' has a wrong offset!");
...
static_assert(sizeof(APyLokiChildActor) == 0x000A78, "Wrong size on APyLokiChildActor");
static_assert(offsetof(APyLokiChildActor, WeaponSlotIndex) == 0x000A70, "Member 'APyLokiChildActor::WeaponSlotIndex' has a wrong offset!");
