...
////static_assert(sizeof(UWBP_Setting_Describe_Bright_C) == 0x000600, "Wrong size on UWBP_Setting_Describe_Bright_C");
////static_assert(offsetof(UWBP_Setting_Describe_Bright_C, Img_Birght_Scene) == 0x0005F0, "Member 'UWBP_Setting_Describe_Bright_C::Img_Birght_Scene' has a wrong offset!");
////static_assert(offsetof(UWBP_Setting_Describe_Bright_C, Img_Scene_Mask) == 0x0005F8, "Member 'UWBP_Setting_Describe_Bright_C::Img_Scene_Mask' has a wrong offset!");
