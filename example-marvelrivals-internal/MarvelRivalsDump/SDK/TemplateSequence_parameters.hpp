...
////static_assert(sizeof(SequenceCameraShakeTestUtil_GetCameraCachePOV) == 0x000A60, "Wrong size on SequenceCameraShakeTestUtil_GetCameraCachePOV");
...
////static_assert(sizeof(SequenceCameraShakeTestUtil_GetLastFrameCameraCachePOV) == 0x000A60, "Wrong size on SequenceCameraShakeTestUtil_GetLastFrameCameraCachePOV");
...
////static_assert(sizeof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache) == 0x000990, "Wrong size on SequenceCameraShakeTestUtil_GetPostProcessBlendCache");
...
////static_assert(offsetof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache, OutPPBlendWeight) == 0x000980, "Member 'SequenceCameraShakeTestUtil_GetPostProcessBlendCache::OutPPBlendWeight' has a wrong offset!");
////static_assert(offsetof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache, ReturnValue) == 0x000984, "Member 'SequenceCameraShakeTestUtil_GetPostProcessBlendCache::ReturnValue' has a wrong offset!");
