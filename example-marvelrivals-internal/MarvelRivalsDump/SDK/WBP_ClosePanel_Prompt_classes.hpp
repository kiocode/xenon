...
//static_assert(sizeof(UWBP_ClosePanel_Prompt_C) == 0x000608, "Wrong size on UWBP_ClosePanel_Prompt_C");
//static_assert(offsetof(UWBP_ClosePanel_Prompt_C, KeyWidget_Right) == 0x0005F0, "Member 'UWBP_ClosePanel_Prompt_C::KeyWidget_Right' has a wrong offset!");
//static_assert(offsetof(UWBP_ClosePanel_Prompt_C, KeyWidget_Space) == 0x0005F8, "Member 'UWBP_ClosePanel_Prompt_C::KeyWidget_Space' has a wrong offset!");
//static_assert(offsetof(UWBP_ClosePanel_Prompt_C, Text_Prompt) == 0x000600, "Member 'UWBP_ClosePanel_Prompt_C::Text_Prompt' has a wrong offset!");
