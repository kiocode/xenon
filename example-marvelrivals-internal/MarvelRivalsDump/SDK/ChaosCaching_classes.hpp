...
//static_assert(sizeof(AChaosCacheManager) == 0x000540, "Wrong size on AChaosCacheManager");
//static_assert(offsetof(AChaosCacheManager, CacheCollection) == 0x000490, "Member 'AChaosCacheManager::CacheCollection' has a wrong offset!");
//static_assert(offsetof(AChaosCacheManager, CacheMode) == 0x000498, "Member 'AChaosCacheManager::CacheMode' has a wrong offset!");
//static_assert(offsetof(AChaosCacheManager, StartMode) == 0x000499, "Member 'AChaosCacheManager::StartMode' has a wrong offset!");
//static_assert(offsetof(AChaosCacheManager, StartTime) == 0x00049C, "Member 'AChaosCacheManager::StartTime' has a wrong offset!");
//static_assert(offsetof(AChaosCacheManager, bIsStatic) == 0x0004A0, "Member 'AChaosCacheManager::bIsStatic' has a wrong offset!");
//static_assert(offsetof(AChaosCacheManager, ObservedComponents) == 0x0004A8, "Member 'AChaosCacheManager::ObservedComponents' has a wrong offset!");
...
//static_assert(sizeof(AChaosCachePlayer) == 0x000540, "Wrong size on AChaosCachePlayer");
