...
static_assert(sizeof(UPyUIController_101661) == 0x000C60, "Wrong size on UPyUIController_101661");
...
static_assert(sizeof(UPyAbility_101661) == 0x002740, "Wrong size on UPyAbility_101661");
