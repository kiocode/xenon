...
//static_assert(sizeof(UAnimationCompressionLibraryDatabase) == 0x000170, "Wrong size on UAnimationCompressionLibraryDatabase");
...
//static_assert(offsetof(UAnimationCompressionLibraryDatabase, MaxStreamRequestSizeKB) == 0x000168, "Member 'UAnimationCompressionLibraryDatabase::MaxStreamRequestSizeKB' has a wrong offset!");
...
//static_assert(sizeof(UAnimCurveCompressionCodec_ACL) == 0x000040, "Wrong size on UAnimCurveCompressionCodec_ACL");
