...
//static_assert(sizeof(UAbility_104011_BP_C) == 0x002610, "Wrong size on UAbility_104011_BP_C");
//static_assert(offsetof(UAbility_104011_BP_C, UberGraphFrame) == 0x002608, "Member 'UAbility_104011_BP_C::UberGraphFrame' has a wrong offset!");
