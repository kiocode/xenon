...
static_assert(sizeof(UPyAbility_103731) == 0x002588, "Wrong size on UPyAbility_103731");
...
static_assert(sizeof(APyCue_Summoner_Loop_10373101) == 0x000FE0, "Wrong size on APyCue_Summoner_Loop_10373101");
