...
static_assert(sizeof(FGameplayAbilityRepAnimMontage) == 0x0000F0, "Wrong size on FGameplayAbilityRepAnimMontage");
...
static_assert(offsetof(FGameplayAbilityRepAnimMontage, AnimMontageSoftPtr) == 0x000008, "Member 'FGameplayAbilityRepAnimMontage::AnimMontageSoftPtr' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, PlayRate) == 0x000038, "Member 'FGameplayAbilityRepAnimMontage::PlayRate' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, Position) == 0x00003C, "Member 'FGameplayAbilityRepAnimMontage::Position' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, BlendTime) == 0x000040, "Member 'FGameplayAbilityRepAnimMontage::BlendTime' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, NextSectionID) == 0x000044, "Member 'FGameplayAbilityRepAnimMontage::NextSectionID' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, PlayInstanceId) == 0x000045, "Member 'FGameplayAbilityRepAnimMontage::PlayInstanceId' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, PredictionKey) == 0x000048, "Member 'FGameplayAbilityRepAnimMontage::PredictionKey' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, SectionIdToPlay) == 0x0000E8, "Member 'FGameplayAbilityRepAnimMontage::SectionIdToPlay' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, AbilityID) == 0x0000EC, "Member 'FGameplayAbilityRepAnimMontage::AbilityID' has a wrong offset!");
...
static_assert(sizeof(FActiveGameplayEffect) == 0x000910, "Wrong size on FActiveGameplayEffect");
...
static_assert(sizeof(FAbilityEndContext) == 0x0000C0, "Wrong size on FAbilityEndContext");
...
static_assert(sizeof(FAbilityActivationExtraInfo) == 0x000028, "Wrong size on FAbilityActivationExtraInfo");
...
static_assert(sizeof(FPredictionKeyContext) == 0x000060, "Wrong size on FPredictionKeyContext");
...
static_assert(sizeof(FAttributeMetaData) == 0x000048, "Wrong size on FAttributeMetaData");
static_assert(offsetof(FAttributeMetaData, BaseValue) == 0x000020, "Member 'FAttributeMetaData::BaseValue' has a wrong offset!");
static_assert(offsetof(FAttributeMetaData, MinValue) == 0x000024, "Member 'FAttributeMetaData::MinValue' has a wrong offset!");
static_assert(offsetof(FAttributeMetaData, MaxValue) == 0x000028, "Member 'FAttributeMetaData::MaxValue' has a wrong offset!");
static_assert(offsetof(FAttributeMetaData, DerivedAttributeInfo) == 0x000030, "Member 'FAttributeMetaData::DerivedAttributeInfo' has a wrong offset!");
static_assert(offsetof(FAttributeMetaData, bCanStack) == 0x000040, "Member 'FAttributeMetaData::bCanStack' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilityTargetData_SingleTargetHit) == 0x000180, "Wrong size on FGameplayAbilityTargetData_SingleTargetHit");
...
static_assert(offsetof(FGameplayAbilityTargetData_SingleTargetHit, bHitReplaced) == 0x000178, "Member 'FGameplayAbilityTargetData_SingleTargetHit::bHitReplaced' has a wrong offset!");
