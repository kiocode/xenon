...
public:
	...
	FMulticastInlineDelegateProperty_             OnItemChanged;                                     // 0x0618(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_DropDownList_ListView) == 0x000628, "Wrong size on UPyWidget_DropDownList_ListView");
static_assert(offsetof(UPyWidget_DropDownList_ListView, OnItemChanged) == 0x000618, "Member 'UPyWidget_DropDownList_ListView::OnItemChanged' has a wrong offset!");
