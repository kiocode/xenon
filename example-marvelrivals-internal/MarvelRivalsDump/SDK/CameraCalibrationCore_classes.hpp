...
//static_assert(sizeof(UCalibrationPointComponent) == 0x000990, "Wrong size on UCalibrationPointComponent");
//static_assert(offsetof(UCalibrationPointComponent, SubPoints) == 0x000930, "Member 'UCalibrationPointComponent::SubPoints' has a wrong offset!");
//static_assert(offsetof(UCalibrationPointComponent, bVisualizePointsInEditor) == 0x000980, "Member 'UCalibrationPointComponent::bVisualizePointsInEditor' has a wrong offset!");
//static_assert(offsetof(UCalibrationPointComponent, PointVisualizationScale) == 0x000984, "Member 'UCalibrationPointComponent::PointVisualizationScale' has a wrong offset!");
//static_assert(offsetof(UCalibrationPointComponent, VisualizationShape) == 0x000988, "Member 'UCalibrationPointComponent::VisualizationShape' has a wrong offset!");
...
//static_assert(sizeof(ACameraCalibrationCheckerboard) == 0x0004E8, "Wrong size on ACameraCalibrationCheckerboard");
//static_assert(offsetof(ACameraCalibrationCheckerboard, Root) == 0x000490, "Member 'ACameraCalibrationCheckerboard::Root' has a wrong offset!");
//static_assert(offsetof(ACameraCalibrationCheckerboard, TopLeft) == 0x000498, "Member 'ACameraCalibrationCheckerboard::TopLeft' has a wrong offset!");
//static_assert(offsetof(ACameraCalibrationCheckerboard, TopRight) == 0x0004A0, "Member 'ACameraCalibrationCheckerboard::TopRight' has a wrong offset!");
//static_assert(offsetof(ACameraCalibrationCheckerboard, BottomLeft) == 0x0004A8, "Member 'ACameraCalibrationCheckerboard::BottomLeft' has a wrong offset!");
//static_assert(offsetof(ACameraCalibrationCheckerboard, BottomRight) == 0x0004B0, "Member 'ACameraCalibrationCheckerboard::BottomRight' has a wrong offset!");
//static_assert(offsetof(ACameraCalibrationCheckerboard, Center) == 0x0004B8, "Member 'ACameraCalibrationCheckerboard::Center' has a wrong offset!");
//static_assert(offsetof(ACameraCalibrationCheckerboard, NumCornerRows) == 0x0004C0, "Member 'ACameraCalibrationCheckerboard::NumCornerRows' has a wrong offset!");
//static_assert(offsetof(ACameraCalibrationCheckerboard, NumCornerCols) == 0x0004C4, "Member 'ACameraCalibrationCheckerboard::NumCornerCols' has a wrong offset!");
//static_assert(offsetof(ACameraCalibrationCheckerboard, SquareSideLength) == 0x0004C8, "Member 'ACameraCalibrationCheckerboard::SquareSideLength' has a wrong offset!");
//static_assert(offsetof(ACameraCalibrationCheckerboard, Thickness) == 0x0004CC, "Member 'ACameraCalibrationCheckerboard::Thickness' has a wrong offset!");
//static_assert(offsetof(ACameraCalibrationCheckerboard, CubeMesh) == 0x0004D0, "Member 'ACameraCalibrationCheckerboard::CubeMesh' has a wrong offset!");
//static_assert(offsetof(ACameraCalibrationCheckerboard, OddCubeMaterial) == 0x0004D8, "Member 'ACameraCalibrationCheckerboard::OddCubeMaterial' has a wrong offset!");
//static_assert(offsetof(ACameraCalibrationCheckerboard, EvenCubeMaterial) == 0x0004E0, "Member 'ACameraCalibrationCheckerboard::EvenCubeMaterial' has a wrong offset!");
