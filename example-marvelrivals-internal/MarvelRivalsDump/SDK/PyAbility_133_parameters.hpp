...
static_assert(sizeof(PyProjectile_13301_K2_OnProcessHit) == 0x000170, "Wrong size on PyProjectile_13301_K2_OnProcessHit");
...
static_assert(sizeof(PyProjectile_13301_K2_OnFlyOverMaxDistance) == 0x000170, "Wrong size on PyProjectile_13301_K2_OnFlyOverMaxDistance");
...
static_assert(sizeof(PyAbility_133_Delegate_ProjetileHitDispatcher__DelegateSignature) == 0x000170, "Wrong size on PyAbility_133_Delegate_ProjetileHitDispatcher__DelegateSignature");
...
static_assert(sizeof(PyAbility_133_K2_OnServerReceiveClientMissileData) == 0x000178, "Wrong size on PyAbility_133_K2_OnServerReceiveClientMissileData");
...
static_assert(offsetof(PyAbility_133_K2_OnServerReceiveClientMissileData, bNeedSpecialMove) == 0x000170, "Member 'PyAbility_133_K2_OnServerReceiveClientMissileData::bNeedSpecialMove' has a wrong offset!");
static_assert(offsetof(PyAbility_133_K2_OnServerReceiveClientMissileData, bIsHitGround) == 0x000171, "Member 'PyAbility_133_K2_OnServerReceiveClientMissileData::bIsHitGround' has a wrong offset!");
...
static_assert(sizeof(PyAbility_133_K2_ReadySimpleSwing) == 0x000190, "Wrong size on PyAbility_133_K2_ReadySimpleSwing");
