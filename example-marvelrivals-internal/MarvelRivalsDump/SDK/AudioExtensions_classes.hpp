...
//static_assert(sizeof(USourceDataOverridePluginSourceSettingsBase) == 0x000030, "Wrong size on USourceDataOverridePluginSourceSettingsBase");
...
//static_assert(sizeof(IAudioParameterControllerInterface) == 0x000030, "Wrong size on IAudioParameterControllerInterface");
...
//static_assert(sizeof(UAudioCodecEncoderSettings) == 0x000038, "Wrong size on UAudioCodecEncoderSettings");
//static_assert(offsetof(UAudioCodecEncoderSettings, Version) == 0x000030, "Member 'UAudioCodecEncoderSettings::Version' has a wrong offset!");
...
//static_assert(sizeof(USoundModulatorBase) == 0x000038, "Wrong size on USoundModulatorBase");
...
//static_assert(sizeof(UWaveformTransformationBase) == 0x000030, "Wrong size on UWaveformTransformationBase");
...
//static_assert(sizeof(UWaveformTransformationChain) == 0x000040, "Wrong size on UWaveformTransformationChain");
//static_assert(offsetof(UWaveformTransformationChain, Transformations) == 0x000030, "Member 'UWaveformTransformationChain::Transformations' has a wrong offset!");
