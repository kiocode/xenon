...
static_assert(sizeof(UPyAbility_102612) == 0x0025A0, "Wrong size on UPyAbility_102612");
static_assert(offsetof(UPyAbility_102612, CanAirJump) == 0x002598, "Member 'UPyAbility_102612::CanAirJump' has a wrong offset!");
