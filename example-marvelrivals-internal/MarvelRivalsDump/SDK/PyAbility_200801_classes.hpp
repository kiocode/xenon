...
static_assert(sizeof(APyCue_Ability_Loop_20080101) == 0x000E80, "Wrong size on APyCue_Ability_Loop_20080101");
static_assert(offsetof(APyCue_Ability_Loop_20080101, FXSocketName) == 0x000E50, "Member 'APyCue_Ability_Loop_20080101::FXSocketName' has a wrong offset!");
static_assert(offsetof(APyCue_Ability_Loop_20080101, EnterStealthTime) == 0x000E60, "Member 'APyCue_Ability_Loop_20080101::EnterStealthTime' has a wrong offset!");
static_assert(offsetof(APyCue_Ability_Loop_20080101, StartAudio) == 0x000E68, "Member 'APyCue_Ability_Loop_20080101::StartAudio' has a wrong offset!");
static_assert(offsetof(APyCue_Ability_Loop_20080101, LoopAudio) == 0x000E70, "Member 'APyCue_Ability_Loop_20080101::LoopAudio' has a wrong offset!");
static_assert(offsetof(APyCue_Ability_Loop_20080101, StopAudio) == 0x000E78, "Member 'APyCue_Ability_Loop_20080101::StopAudio' has a wrong offset!");
...
static_assert(sizeof(UPyAbility_200801) == 0x002590, "Wrong size on UPyAbility_200801");
static_assert(offsetof(UPyAbility_200801, TraceProgress) == 0x002580, "Member 'UPyAbility_200801::TraceProgress' has a wrong offset!");
static_assert(offsetof(UPyAbility_200801, TargetTrajectoryPortal) == 0x002588, "Member 'UPyAbility_200801::TargetTrajectoryPortal' has a wrong offset!");
