...
//static_assert(sizeof(FRichTextStyleRow) == 0x000370, "Wrong size on FRichTextStyleRow");
//static_assert(offsetof(FRichTextStyleRow, TextStyle) == 0x000020, "Member 'FRichTextStyleRow::TextStyle' has a wrong offset!");
...
//static_assert(sizeof(FRichImageRow) == 0x0000F0, "Wrong size on FRichImageRow");
//static_assert(offsetof(FRichImageRow, Brush) == 0x000020, "Member 'FRichImageRow::Brush' has a wrong offset!");
...
//static_assert(sizeof(FRichImageTextRow) == 0x000480, "Wrong size on FRichImageTextRow");
//static_assert(offsetof(FRichImageTextRow, TextStyle) == 0x000020, "Member 'FRichImageTextRow::TextStyle' has a wrong offset!");
//static_assert(offsetof(FRichImageTextRow, Brush) == 0x000370, "Member 'FRichImageTextRow::Brush' has a wrong offset!");
//static_assert(offsetof(FRichImageTextRow, Padding) == 0x000440, "Member 'FRichImageTextRow::Padding' has a wrong offset!");
//static_assert(offsetof(FRichImageTextRow, TextPadding) == 0x000450, "Member 'FRichImageTextRow::TextPadding' has a wrong offset!");
//static_assert(offsetof(FRichImageTextRow, IsAdaptive) == 0x000460, "Member 'FRichImageTextRow::IsAdaptive' has a wrong offset!");
//static_assert(offsetof(FRichImageTextRow, WidthPadding) == 0x000464, "Member 'FRichImageTextRow::WidthPadding' has a wrong offset!");
//static_assert(offsetof(FRichImageTextRow, MinFontSize) == 0x000468, "Member 'FRichImageTextRow::MinFontSize' has a wrong offset!");
//static_assert(offsetof(FRichImageTextRow, MinWidth) == 0x00046C, "Member 'FRichImageTextRow::MinWidth' has a wrong offset!");
//static_assert(offsetof(FRichImageTextRow, MaxWidth) == 0x000470, "Member 'FRichImageTextRow::MaxWidth' has a wrong offset!");
