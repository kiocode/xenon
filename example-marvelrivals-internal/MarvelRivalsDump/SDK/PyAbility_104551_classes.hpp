...
{
public:
	FMulticastInlineDelegateProperty_             OnOctopusStateChangedDelegate;                     // 0x0FF0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnOctopusTargetChangedDelegate;                    // 0x1000(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSummonedBeginAgentTaskDelegate;                  // 0x1010(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APySummoned_10455101) == 0x001020, "Wrong size on APySummoned_10455101");
static_assert(offsetof(APySummoned_10455101, OnOctopusStateChangedDelegate) == 0x000FF0, "Member 'APySummoned_10455101::OnOctopusStateChangedDelegate' has a wrong offset!");
static_assert(offsetof(APySummoned_10455101, OnOctopusTargetChangedDelegate) == 0x001000, "Member 'APySummoned_10455101::OnOctopusTargetChangedDelegate' has a wrong offset!");
static_assert(offsetof(APySummoned_10455101, OnSummonedBeginAgentTaskDelegate) == 0x001010, "Member 'APySummoned_10455101::OnSummonedBeginAgentTaskDelegate' has a wrong offset!");
...
static_assert(sizeof(APyProjectile_10455101) == 0x003050, "Wrong size on APyProjectile_10455101");
...
static_assert(sizeof(APyProjectile_10455102) == 0x003050, "Wrong size on APyProjectile_10455102");
...
static_assert(sizeof(UPyConfig_104551) == 0x001050, "Wrong size on UPyConfig_104551");
...
static_assert(offsetof(UPyConfig_104551, SummonedClass) == 0x001040, "Member 'UPyConfig_104551::SummonedClass' has a wrong offset!");
...
static_assert(sizeof(UPyAbility_104551) == 0x002588, "Wrong size on UPyAbility_104551");
...
static_assert(sizeof(APyCue_Summoner_Loop_10455101) == 0x000EA0, "Wrong size on APyCue_Summoner_Loop_10455101");
static_assert(offsetof(APyCue_Summoner_Loop_10455101, TimeToHideChildActor) == 0x000E90, "Member 'APyCue_Summoner_Loop_10455101::TimeToHideChildActor' has a wrong offset!");
static_assert(offsetof(APyCue_Summoner_Loop_10455101, NormalAttackPromptAudioID) == 0x000E94, "Member 'APyCue_Summoner_Loop_10455101::NormalAttackPromptAudioID' has a wrong offset!");
static_assert(offsetof(APyCue_Summoner_Loop_10455101, EnhancedAttackPromptAudioID) == 0x000E98, "Member 'APyCue_Summoner_Loop_10455101::EnhancedAttackPromptAudioID' has a wrong offset!");
