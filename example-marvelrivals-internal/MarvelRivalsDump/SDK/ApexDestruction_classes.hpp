...
public:
	...
	FMulticastInlineDelegateProperty_             OnActorFracture;                                   // 0x0498(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
//static_assert(sizeof(ADestructibleActor) == 0x0004A8, "Wrong size on ADestructibleActor");
//static_assert(offsetof(ADestructibleActor, DestructibleComponent) == 0x000490, "Member 'ADestructibleActor::DestructibleComponent' has a wrong offset!");
//static_assert(offsetof(ADestructibleActor, OnActorFracture) == 0x000498, "Member 'ADestructibleActor::OnActorFracture' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnComponentFracture;                               // 0x0C80(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
//static_assert(sizeof(UDestructibleComponent) == 0x000D00, "Wrong size on UDestructibleComponent");
//static_assert(offsetof(UDestructibleComponent, FractureEffects) == 0x000C68, "Member 'UDestructibleComponent::FractureEffects' has a wrong offset!");
//static_assert(offsetof(UDestructibleComponent, bEnableHardSleeping) == 0x000C78, "Member 'UDestructibleComponent::bEnableHardSleeping' has a wrong offset!");
//static_assert(offsetof(UDestructibleComponent, LargeChunkThreshold) == 0x000C7C, "Member 'UDestructibleComponent::LargeChunkThreshold' has a wrong offset!");
//static_assert(offsetof(UDestructibleComponent, OnComponentFracture) == 0x000C80, "Member 'UDestructibleComponent::OnComponentFracture' has a wrong offset!");
