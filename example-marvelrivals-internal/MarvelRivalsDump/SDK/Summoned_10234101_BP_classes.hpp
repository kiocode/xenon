...
//static_assert(sizeof(ASummoned_10234101_BP_C) == 0x000930, "Wrong size on ASummoned_10234101_BP_C");
//static_assert(offsetof(ASummoned_10234101_BP_C, NavEffectBox) == 0x000920, "Member 'ASummoned_10234101_BP_C::NavEffectBox' has a wrong offset!");
//static_assert(offsetof(ASummoned_10234101_BP_C, MarvelNavModifier) == 0x000928, "Member 'ASummoned_10234101_BP_C::MarvelNavModifier' has a wrong offset!");
