...
////static_assert(sizeof(IRigVMGraphFunctionHost) == 0x000030, "Wrong size on IRigVMGraphFunctionHost");
...
////static_assert(sizeof(URigVMBlueprintGeneratedClass) == 0x000418, "Wrong size on URigVMBlueprintGeneratedClass");
////static_assert(offsetof(URigVMBlueprintGeneratedClass, GraphFunctionStore) == 0x0003F8, "Member 'URigVMBlueprintGeneratedClass::GraphFunctionStore' has a wrong offset!");
...
////static_assert(sizeof(URigVMMemoryStorageGeneratorClass) == 0x0002C0, "Wrong size on URigVMMemoryStorageGeneratorClass");
