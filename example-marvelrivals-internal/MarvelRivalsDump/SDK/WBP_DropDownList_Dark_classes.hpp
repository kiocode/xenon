...
////static_assert(sizeof(UWBP_DropDownList_Dark_C) == 0x0015E0, "Wrong size on UWBP_DropDownList_Dark_C");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, Canvas_DropDownList) == 0x001570, "Member 'UWBP_DropDownList_Dark_C::Canvas_DropDownList' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, HorBox_Title) == 0x001578, "Member 'UWBP_DropDownList_Dark_C::HorBox_Title' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, Img_AddTextture) == 0x001580, "Member 'UWBP_DropDownList_Dark_C::Img_AddTextture' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, Img_Arrow) == 0x001588, "Member 'UWBP_DropDownList_Dark_C::Img_Arrow' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, Img_RightTop) == 0x001590, "Member 'UWBP_DropDownList_Dark_C::Img_RightTop' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, Img_Tips) == 0x001598, "Member 'UWBP_DropDownList_Dark_C::Img_Tips' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, MenuAnchor) == 0x0015A0, "Member 'UWBP_DropDownList_Dark_C::MenuAnchor' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, Overlay_Icon) == 0x0015A8, "Member 'UWBP_DropDownList_Dark_C::Overlay_Icon' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, Overlay_ListView) == 0x0015B0, "Member 'UWBP_DropDownList_Dark_C::Overlay_ListView' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, Overlay_MainBtn) == 0x0015B8, "Member 'UWBP_DropDownList_Dark_C::Overlay_MainBtn' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, Overlay_Texture) == 0x0015C0, "Member 'UWBP_DropDownList_Dark_C::Overlay_Texture' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, SizeBox_Icon) == 0x0015C8, "Member 'UWBP_DropDownList_Dark_C::SizeBox_Icon' has a wrong offset!");
////static_assert(offsetof(UWBP_DropDownList_Dark_C, Text_Title) == 0x0015D0, "Member 'UWBP_DropDownList_Dark_C::Text_Title' has a wrong offset!");
