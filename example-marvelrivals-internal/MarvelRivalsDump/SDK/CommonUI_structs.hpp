...
static_assert(sizeof(FRichTextIconData) == 0x000078, "Wrong size on FRichTextIconData");
static_assert(offsetof(FRichTextIconData, DisplayName) == 0x000020, "Member 'FRichTextIconData::DisplayName' has a wrong offset!");
static_assert(offsetof(FRichTextIconData, ResourceObject) == 0x000038, "Member 'FRichTextIconData::ResourceObject' has a wrong offset!");
static_assert(offsetof(FRichTextIconData, ImageSize) == 0x000068, "Member 'FRichTextIconData::ImageSize' has a wrong offset!");
...
static_assert(sizeof(FCommonInputActionDataBase) == 0x0003B0, "Wrong size on FCommonInputActionDataBase");
static_assert(offsetof(FCommonInputActionDataBase, DisplayName) == 0x000020, "Member 'FCommonInputActionDataBase::DisplayName' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, HoldDisplayName) == 0x000038, "Member 'FCommonInputActionDataBase::HoldDisplayName' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, NavBarPriority) == 0x000050, "Member 'FCommonInputActionDataBase::NavBarPriority' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, KeyboardInputTypeInfo) == 0x000060, "Member 'FCommonInputActionDataBase::KeyboardInputTypeInfo' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, DefaultGamepadInputTypeInfo) == 0x000160, "Member 'FCommonInputActionDataBase::DefaultGamepadInputTypeInfo' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, GamepadInputOverrides) == 0x000260, "Member 'FCommonInputActionDataBase::GamepadInputOverrides' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, TouchInputTypeInfo) == 0x0002B0, "Member 'FCommonInputActionDataBase::TouchInputTypeInfo' has a wrong offset!");
