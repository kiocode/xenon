...
static_assert(sizeof(APyDoor) == 0x000520, "Wrong size on APyDoor");
static_assert(offsetof(APyDoor, OpenState) == 0x0004E0, "Member 'APyDoor::OpenState' has a wrong offset!");
static_assert(offsetof(APyDoor, DoorProgress) == 0x0004E4, "Member 'APyDoor::DoorProgress' has a wrong offset!");
static_assert(offsetof(APyDoor, AudioEvent) == 0x0004E8, "Member 'APyDoor::AudioEvent' has a wrong offset!");
static_assert(offsetof(APyDoor, StartOpenDoorEvent) == 0x0004F0, "Member 'APyDoor::StartOpenDoorEvent' has a wrong offset!");
static_assert(offsetof(APyDoor, EndOpenDoorEvent) == 0x0004F8, "Member 'APyDoor::EndOpenDoorEvent' has a wrong offset!");
static_assert(offsetof(APyDoor, OpenProcessEvent) == 0x000500, "Member 'APyDoor::OpenProcessEvent' has a wrong offset!");
static_assert(offsetof(APyDoor, StartCloseDoorEvent) == 0x000508, "Member 'APyDoor::StartCloseDoorEvent' has a wrong offset!");
static_assert(offsetof(APyDoor, EndCloseDoorEvent) == 0x000510, "Member 'APyDoor::EndCloseDoorEvent' has a wrong offset!");
static_assert(offsetof(APyDoor, CloseProcessEvent) == 0x000518, "Member 'APyDoor::CloseProcessEvent' has a wrong offset!");
