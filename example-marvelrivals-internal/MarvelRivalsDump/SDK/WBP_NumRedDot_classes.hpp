...
////static_assert(sizeof(UWBP_NumRedDot_C) == 0x000650, "Wrong size on UWBP_NumRedDot_C");
////static_assert(offsetof(UWBP_NumRedDot_C, UberGraphFrame) == 0x000600, "Member 'UWBP_NumRedDot_C::UberGraphFrame' has a wrong offset!");
////static_assert(offsetof(UWBP_NumRedDot_C, Img_bg) == 0x000608, "Member 'UWBP_NumRedDot_C::Img_bg' has a wrong offset!");
////static_assert(offsetof(UWBP_NumRedDot_C, Img_bg_2) == 0x000610, "Member 'UWBP_NumRedDot_C::Img_bg_2' has a wrong offset!");
////static_assert(offsetof(UWBP_NumRedDot_C, Img_Bg_2Vx) == 0x000618, "Member 'UWBP_NumRedDot_C::Img_Bg_2Vx' has a wrong offset!");
////static_assert(offsetof(UWBP_NumRedDot_C, Img_Bg_Vx) == 0x000620, "Member 'UWBP_NumRedDot_C::Img_Bg_Vx' has a wrong offset!");
////static_assert(offsetof(UWBP_NumRedDot_C, SizeBox_Number1) == 0x000628, "Member 'UWBP_NumRedDot_C::SizeBox_Number1' has a wrong offset!");
////static_assert(offsetof(UWBP_NumRedDot_C, SizeBox_Number2) == 0x000630, "Member 'UWBP_NumRedDot_C::SizeBox_Number2' has a wrong offset!");
////static_assert(offsetof(UWBP_NumRedDot_C, Text_Num) == 0x000638, "Member 'UWBP_NumRedDot_C::Text_Num' has a wrong offset!");
////static_assert(offsetof(UWBP_NumRedDot_C, Text_Num_2) == 0x000640, "Member 'UWBP_NumRedDot_C::Text_Num_2' has a wrong offset!");
////static_assert(offsetof(UWBP_NumRedDot_C, Number) == 0x000648, "Member 'UWBP_NumRedDot_C::Number' has a wrong offset!");
