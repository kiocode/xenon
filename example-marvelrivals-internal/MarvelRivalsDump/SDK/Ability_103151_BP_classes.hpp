...
////static_assert(sizeof(UAbility_103151_BP_C) == 0x002590, "Wrong size on UAbility_103151_BP_C");
////static_assert(offsetof(UAbility_103151_BP_C, UberGraphFrame) == 0x002588, "Member 'UAbility_103151_BP_C::UberGraphFrame' has a wrong offset!");
