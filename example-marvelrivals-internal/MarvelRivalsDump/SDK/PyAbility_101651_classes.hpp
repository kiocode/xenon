...
//static_assert(sizeof(UPyUIController_101651) == 0x000C60, "Wrong size on UPyUIController_101651");
...
{
public:
	FMulticastInlineDelegateProperty_             DelegateOnHidePhantomWhenTeleport;                 // 0x0FE0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
//static_assert(sizeof(APySummoned_10165101) == 0x000FF0, "Wrong size on APySummoned_10165101");
//static_assert(offsetof(APySummoned_10165101, DelegateOnHidePhantomWhenTeleport) == 0x000FE0, "Member 'APySummoned_10165101::DelegateOnHidePhantomWhenTeleport' has a wrong offset!");
...
//static_assert(sizeof(UPyAbility_101651) == 0x002640, "Wrong size on UPyAbility_101651");
//static_assert(offsetof(UPyAbility_101651, PhantomCharacter) == 0x002638, "Member 'UPyAbility_101651::PhantomCharacter' has a wrong offset!");
...
//static_assert(sizeof(APyCue_Summoner_Loop_10165101) == 0x000F30, "Wrong size on APyCue_Summoner_Loop_10165101");
//static_assert(offsetof(APyCue_Summoner_Loop_10165101, CollabrateReleaseFX) == 0x000F28, "Member 'APyCue_Summoner_Loop_10165101::CollabrateReleaseFX' has a wrong offset!");
...
//static_assert(sizeof(APyCue_TraceActor_10165101) == 0x000D78, "Wrong size on APyCue_TraceActor_10165101");
...
//static_assert(sizeof(APyLokiSpaceActor) == 0x0004A8, "Wrong size on APyLokiSpaceActor");
